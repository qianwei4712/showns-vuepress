import{_ as e,r as t,o as l,c as i,b as n,a as c,w as d,d as p,f as s}from"./app-0869a5be.js";const o={},r=s('<div class="catalog"><ul><li><a href="#t0">JVM 介绍</a></li><li><a href="#t1">Java 字节码文件</a><ul><li><a href="#t11">字节码文件结构</a></li><li><a href="#t12">反编译字节码文件</a></li></ul></li><li><a href="#te">参考文章</a></li></ul></div><h2 id="jvm-介绍" tabindex="-1"><a class="header-anchor" href="#jvm-介绍" aria-hidden="true">#</a> <span id="t0">JVM 介绍</span></h2><p>众所周知，Java 是运行在 Java 虚拟机上的，.<code>java</code> 文件只有编译成为 <code>.class</code> 文件才能在虚拟机上运行。那么这个虚拟机又是什么？</p>',3),u=s(`<p>Oracle 发布了一般又一般的 Java 和 JVM 规范，虚拟机就是遵循这个规范运行。</p><p>规范的话全英文的，我是看不懂，有兴趣自己取：<a href="https://docs.oracle.com/javase/specs/index.html" target="_blank">https://docs.oracle.com/javase/specs/index.html</a></p><blockquote><p><strong>既然 JVM 存在公开规范，那就说明，它不单单只支持 JAVA，并且，JVM 也不是唯一的。</strong></p></blockquote><p>我们平时认识最多的，应该是 HotSpot ，这是最广泛的 Java 虚拟机。比如查看 java 版本就能发现它</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">java</span> version <span class="token string">&quot;11.0.8&quot;</span> <span class="token number">2020</span>-07-14 LTS
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不同的代码在编译器下可以编译成相同的字节码，字节码也可以在不同的 JVM 上运行。</p><p>虚拟机的区别不会详细研究，都是遵循 JVM 规范，也没有多大区别，并且我们也不会去更改。</p><br><p>然后就是另一个角度，不同代码可以在同一个 JVM 上运行，如下图：</p><p><img src="http://shiva.oss-cn-hangzhou.aliyuncs.com/data/java/JVM、字节码、编译器的关系.png" alt="JVM、字节码、编译器的关系.png"></p><p>虚拟机不关心代码，只要编译成的字节码符合规范，它就能运行。</p><br><h2 id="java-字节码文件" tabindex="-1"><a class="header-anchor" href="#java-字节码文件" aria-hidden="true">#</a> <span id="t1">Java 字节码文件</span></h2><p>对 Java 而言，获得 <code>.class</code> 字节码文件需要通过 <code>javac</code> 编译器，因为在执行的时候，存在对字节码的第二次编译，所以 <code>javac</code> 编译器也成为前端编译。</p><p>先从 <code>Hello World</code> 开始。。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">JvmTest1</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这么一段代码，编译后的 class 文件打开后这样的：</p><div class="language-pseudocode line-numbers-mode" data-ext="pseudocode"><pre class="language-pseudocode"><code>cafe babe 0000 0034 0022 0a00 0600 1409
...
0012 0000 0002 0013
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><h3 id="字节码文件结构" tabindex="-1"><a class="header-anchor" href="#字节码文件结构" aria-hidden="true">#</a> <span id="t11">字节码文件结构</span></h3><blockquote><p>字节码文件结构是一组以 8 位字节为基础的二进制流，各数据项目严格按照顺序紧凑地排列在 Class 文件之中，中间没有添加任何分隔符。</p><p>在字节码结构中，有两种最基本的数据类型来表示字节码文件格式，分别是：无符号数和表。</p></blockquote><p>太复杂的东西我也没看懂，这里都是简单来说，大多数内容也就复制下。。。。</p><p>我们先来看一张表：</p><table><thead><tr><th style="text-align:left;">类型</th><th>名称</th><th>说明</th><th>长度</th></tr></thead><tbody><tr><td style="text-align:left;">u4</td><td>magic</td><td>魔数，识别 Class 文件格式</td><td>4 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>minor_version</td><td>副版本号</td><td>2 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>major_version</td><td>主版本号</td><td>2 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>constant_pool_count</td><td>常量池计算器</td><td>2 个字节</td></tr><tr><td style="text-align:left;">cp_info</td><td>constant_pool</td><td>常量池</td><td>n 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>access_flags</td><td>访问标志</td><td>2 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>this_class</td><td>类索引</td><td>2 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>super_class</td><td>父类索引</td><td>2 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>interfaces_count</td><td>接口计数器</td><td>2 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>interfaces</td><td>接口索引集合</td><td>2 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>fields_count</td><td>字段个数</td><td>2 个字节</td></tr><tr><td style="text-align:left;">field_info</td><td>fields</td><td>字段集合</td><td>n 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>methods_count</td><td>方法计数器</td><td>2 个字节</td></tr><tr><td style="text-align:left;">method_info</td><td>methods</td><td>方法集合</td><td>n 个字节</td></tr><tr><td style="text-align:left;">u2</td><td>attributes_count</td><td>附加属性计数器</td><td>2 个字节</td></tr><tr><td style="text-align:left;">attribute_info</td><td>attributes</td><td>附加属性集合</td><td>n 个字节</td></tr></tbody></table><p>这是一张 Java 字节码总的结构表，我们按照上面的顺序逐一进行解读就可以了。</p><p>详细的就算了，看看主要结构，从大佬那扒来的图：</p><p><img src="https://img-blog.csdnimg.cn/20200922191856568.png" alt="java-jvm-class-2"></p><br><h3 id="反编译字节码文件" tabindex="-1"><a class="header-anchor" href="#反编译字节码文件" aria-hidden="true">#</a> <span id="t12">反编译字节码文件</span></h3><blockquote><p>使用到 java 内置的一个反编译工具 javap 可以反编译字节码文件, 用法: <code>javap -v &lt;classes&gt; </code></p></blockquote><p>比如我执行后输出：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Classfile /E:/HolyShit/test-demos/java-new/target/classes/jvm/JvmTest1.class
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>看看就好了，太多知识性内容我也写不完。。。凑个字数</p><br><h2 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> <span id="te">参考文章</span></h2><p><a href="https://www.cnblogs.com/chanshuyi/p/jvm_serial_02_the_history_of_jvm.html
" target="_blank">https://www.cnblogs.com/chanshuyi/p/jvm_serial_02_the_history_of_jvm.html </a></p><p><a href="https://www.pdai.tech/md/java/jvm/java-jvm-class.html
" target="_blank">https://www.pdai.tech/md/java/jvm/java-jvm-class.html </a></p><p><a href="https://www.cnblogs.com/chanshuyi/p/jvm_serial_05_jvm_bytecode_analysis.html
" target="_blank">https://www.cnblogs.com/chanshuyi/p/jvm_serial_05_jvm_bytecode_analysis.html </a></p><p><a href="https://blog.csdn.net/u011810352/article/details/80316870
" target="_blank">https://blog.csdn.net/u011810352/article/details/80316870 </a></p><p><a href="https://blog.csdn.net/weelyy/article/details/78969412
" target="_blank">https://blog.csdn.net/weelyy/article/details/78969412 </a></p><p><a href="https://www.jianshu.com/p/e713defb5afc
" target="_blank">https://www.jianshu.com/p/e713defb5afc </a></p><p><a href="https://www.cnblogs.com/fx-blog/p/11982275.html
" target="_blank">https://www.cnblogs.com/fx-blog/p/11982275.html </a></p>`,42);function v(m,b){const a=t("font");return l(),i("div",null,[r,n("blockquote",null,[n("p",null,[n("strong",null,[c(a,{color:"red"},{default:d(()=>[p("在 CPU 层面，计算机是由一个个指令汇聚而成的，虚拟机就是将识别字节码文件，并将其转换为指令运行。")]),_:1})])])]),u])}const f=e(o,[["render",v],["__file","ByteCodeFile.html.vue"]]);export{f as default};
