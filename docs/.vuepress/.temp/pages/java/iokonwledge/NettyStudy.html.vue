<template><div><h2 id="开场废话" tabindex="-1"><a class="header-anchor" href="#开场废话" aria-hidden="true">#</a> 开场废话</h2>
<p><code v-pre>2022.04.16，终于到 Netty 了，就是奔着这个来的</code></p>
<blockquote>
<p>官方说明：Netty 是一个异步的，事件驱动的网络应用框架，可以快速开发可维护的高性能协议服务器和客户端。</p>
</blockquote>
<ul>
<li>GitHub 地址：<a href="https://github.com/netty/netty" target="_blank" rel="noopener noreferrer">netty/netty: Netty project - an event-driven asynchronous network application framework (github.com)<ExternalLinkIcon/></a></li>
<li>官方文档：<a href="https://netty.io/wiki/index.html" target="_blank" rel="noopener noreferrer">Netty.docs: Netty.docs: Home<ExternalLinkIcon/></a></li>
<li>[Netty权威指南 第2版 带书签目录 完整版.pdf · Drawing Bed of First/static-resources - 码云 - 开源中国 (gitee.com)](https://gitee.com/pic_bed_of_shiva/static-resources/blob/master/showns/ebook/Netty权威指南 第2版 带书签目录 完整版.pdf)</li>
</ul>
<p>Netty 在网络编程中的地位，相当于 Spring 在 JavaEE 体系中的地位，是当之无愧的武林霸主。</p>
<p>使用 Netty 的框架包括：<code v-pre>Spark</code>、<code v-pre>RocketMQ</code>、<code v-pre>ElasticSearch</code>、<code v-pre>Dubbo</code>、<code v-pre>Zookeeper</code>等，都是大名鼎鼎啊；</p>
<hr>
<p>上面已经说过了，Netty 是基于 NIO 开发的网络协议框架，稳定版本是 4.1;</p>
<p>Netty 5 已经被废弃，原本是为了引入 AIO，后来发现效果不好。</p>
<br/>
<h2 id="入门示例代码" tabindex="-1"><a class="header-anchor" href="#入门示例代码" aria-hidden="true">#</a> 入门示例代码</h2>
<p>引入依赖：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>服务端代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">NettyServer</span> <span class="token punctuation">{</span>
...
<li>Netty 对 <code v-pre>EventLoopGroup</code> 接口针对不同的传输协议提供了不同的实现</li>
<li>Scoket 实现类中，除了 <code v-pre>NioServerSocketChannel</code>，还有以下两种：</li>
</ul>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/image-20220420224115555.png" alt="image-20220420224115555"></p>
<br/>
<p>客户端代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">NettyClient</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
...
<li>ChannelInboundHandlerAdapter 实现类的几个重点方法：</li>
</ul>
<blockquote>
<ol>
<li><strong>channelActive</strong> : 当客户端和服务端建立连接后会调用</li>
<li><strong>channelRead</strong> : 收到消息时将会调用，可以用来处理消息</li>
<li><strong>exceptionCaught</strong> : 发生异常时会调用，可以用来打印断开连接日志，断开触发等</li>
</ol>
</blockquote>
<p>测试运行：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>服务端收到消息：hello
...
<h3 id="channeloption-常见配置" tabindex="-1"><a class="header-anchor" href="#channeloption-常见配置" aria-hidden="true">#</a> ChannelOption 常见配置</h3>
<table>
<thead>
<tr>
<th>参数</th>
...
<td>最长尝试连接时间</td>
<td>用在客户端建立连接时，如果在指定毫秒内无法连接，会抛出 timeout 异常</td>
</tr>
<tr>
<td>ChannelOption.SO_BACKLOG</td>
<td>设置队列的大小</td>
<td>对应 tcp协议 listen函数中的backlog参数，函数用来初始化服务端可连接队列<br>服务端处理客户端连接请求是顺序处理的，所以同一时间只能处理一个客户端连接<br/>多个客户端时，服务端将不能处理的客户端连接请求放在队列中等待处理，backlog参数指定了队列的大小</td>
</tr>
<tr>
<td>ChannelOption.SO_REUSEADDR</td>
<td>允许重复使用本地地址和端口</td>
<td>对应于套接字选项中的SO_REUSEADDR，这个参数表示允许重复使用本地地址和端口</td>
</tr>
<tr>
<td>ChannelOption.SO_KEEPALIVE</td>
<td>设置长链接心跳</td>
<td>当设置该选项以后，如果在两小时内没有数据的通信时，TCP会自动发送一个活动探测数据报文。<br/>不推荐只使用这个参数来维持长链接，还是要自己写。</td>
</tr>
<tr>
<td>ChannelOption.SO_SNDBUF</td>
<td>用于操作发送缓冲区的大小</td>
<td>发送缓冲区用于保存发送数据，直到发送成功。</td>
</tr>
<tr>
<td>ChannelOption.SO_RCVBUF</td>
<td>用于操作接收缓冲区的大小</td>
<td>接收缓冲区用于保存网络协议站内收到的数据，直到应用程序读取成 功</td>
</tr>
<tr>
<td>ChannelOption.SO_LINGER</td>
<td>关闭Socket的延迟时间</td>
<td>0表示socket.close()方法立即返回，OS放弃发送缓冲区的数据直接向对端发送RST包，对端收到复位错误。<br/>非0 表示调用socket.close()方法的线程被阻塞直到延迟时间到或发送缓冲区中的数据发送完毕，若超时，则对端会收到复位错误。</td>
</tr>
<tr>
<td>ChannelOption.TCP_NODELAY</td>
<td>立即发送数据，默认值为Ture</td>
<td>Nagle算法是将小的数据包组装为更大的帧然后进行发送，而不是输入一次发送一次,<br/>因此在数据包不足的时候会等待其他数据的到了，组装成大的数据包进行发送，<br/>虽然该方式有效提高网络的有效负载，但是却造成了延时，，适用于文件传输。</td>
</tr>
<tr>
<td>ChannelOption.IP_TOS</td>
<td>设施优先级和QoS</td>
<td>IP参数，设置IP头部的Type-of-Service字段，用于描述IP包的优先级和QoS选项。</td>
</tr>
</tbody>
</table>
<blockquote>
<p>来源：<a href="https://www.jianshu.com/p/975b30171352" target="_blank" rel="noopener noreferrer">Netty ChannelOption参数详解 - 简书 (jianshu.com)<ExternalLinkIcon/></a></p>
</blockquote>
<br/>
<h2 id="解码器使用" tabindex="-1"><a class="header-anchor" href="#解码器使用" aria-hidden="true">#</a> 解码器使用</h2>
<h3 id="拆包粘包" tabindex="-1"><a class="header-anchor" href="#拆包粘包" aria-hidden="true">#</a> 拆包粘包</h3>
<p>在讲解码器之前，得先了解下 <strong>拆包粘包</strong> 问题，介绍跳过</p>
<ul>
<li>理论基础可以看：<a href="https://www.yuque.com/shiva/lct37n/dxczcg" target="_blank" rel="noopener noreferrer">TCP 粘包、拆包问题，及解决方案 · 语雀 (yuque.com)<ExternalLinkIcon/></a></li>
<li>测试代码：<a href="https://gitee.com/learning-use-cases/junit-of-scattered/tree/e9558d9369d098d42eedd175c44ffbc4c48b269a/jdk-source/src/main/java/netty/demo2" target="_blank" rel="noopener noreferrer">jdk-source/src/main/java/netty/demo2<ExternalLinkIcon/></a></li>
</ul>
<p>这里先使用 Netty 自带的 <code v-pre>LineBasedFrameDecoder</code> 和 <code v-pre>StringDecoder</code> 解码器来测试，先使用最基础的按行分割。</p>
<hr>
<p>对上面的代码进行修改，然后再测试。</p>
<p>服务端和客户端都添加业务处理解码器：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>NioServerHandler 处理类，channelRead 读取方法修改：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">int</span> count<span class="token punctuation">;</span>
...
<p>因为用了 <code v-pre>StringDecoder</code> 解码器，直接转 string 就能用</p>
</blockquote>
<hr>
<p>NioClientHandler 处理类，channelActive 方法修改：</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>收到消息次数：1服务端收到消息：hello~ mother fucker!
.....
收到消息次数：10服务端收到消息：hello~ mother fucker!
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>客户端收到消息：1650685447037
...
客户端收到消息：1650685447044
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br/>
<h4 id="linebasedframedecoder" tabindex="-1"><a class="header-anchor" href="#linebasedframedecoder" aria-hidden="true">#</a> LineBasedFrameDecoder</h4>
<blockquote>
<p>行分隔符解码器，遇到 <code v-pre>\n</code> 或 <code v-pre>\r\n</code> ，则认为是一个完整的报文</p>
</blockquote>
<p>工作原理如下：</p>
<ol>
<li>依次遍历 ByteBuf 中的可读字节，判断是否有 <code v-pre>\n</code> 或 <code v-pre>\r\n</code> 。</li>
<li>如果有，就从此位置结束读取，把读取到的字节组成一个数据包。</li>
<li>然后发到下一个解码器。</li>
</ol>
<p><strong>如果读取到最大长度，仍然没有读取到换行符，则会抛出异常。同时忽略已经读到的流数据。</strong></p>
<br/>
<h4 id="delimiterbasedframedecoder" tabindex="-1"><a class="header-anchor" href="#delimiterbasedframedecoder" aria-hidden="true">#</a> DelimiterBasedFrameDecoder</h4>
<blockquote>
<p>分隔符解码器，作用与 LineBasedFrameDecoder 类似，<strong>只不过分隔符可以自己指定</strong></p>
</blockquote>
<p>可以这么用，只要把指定的分隔符传入就行：</p>
...
<h4 id="lengthfieldbasedframedecoder" tabindex="-1"><a class="header-anchor" href="#lengthfieldbasedframedecoder" aria-hidden="true">#</a> LengthFieldBasedFrameDecoder</h4>
<blockquote>
<p>通过在包头增加消息体长度的解码器，解析数据时首先获取首部长度，然后定长读取socket中的数据。</p>
</blockquote>
<ul>
<li>感觉这个会比较重要，所以单独写了个文章</li>
<li>传送门：<a href="https://www.yuque.com/shiva/lct37n/bbg5ml" target="_blank" rel="noopener noreferrer">LengthFieldBasedFrameDecoder 解码器 · 语雀 (yuque.com)<ExternalLinkIcon/></a></li>
</ul>
<br/>
<h4 id="其他解码器" tabindex="-1"><a class="header-anchor" href="#其他解码器" aria-hidden="true">#</a> 其他解码器</h4>
<table>
<thead>
<tr>
<th>解码器</th>
...
<tr>
<td>StringDecoder</td>
<td>StringDecoder 功能比较明显，把收到的数据包转为字符串，然后继续调用后续的 Handler.</td>
</tr>
<tr>
<td>FixedLengthFrameDecoder</td>
<td>定长协议解码器，可以指定固定的字节数算一个完整的报文</td>
</tr>
<tr>
<td>Base64Decoder</td>
<td>用于Base64编码</td>
...
<tr>
<td>JsonObjectDecoder</td>
<td>json格式解码器，当检测到匹配数量的&quot;{&quot; 、”}”或”[””]”时，则认为是一个完整的 json</td>
</tr>
<tr>
<td>MessageToMessageDecoder</td>
<td>将一个本身就包含完整报文信息的对象转换成另一个Java对象</td>
</tr>
</tbody>
</table>
<br/>
<h3 id="自定义解码器" tabindex="-1"><a class="header-anchor" href="#自定义解码器" aria-hidden="true">#</a> 自定义解码器</h3>
<p>其实也没什么好说的，</p>
<ol>
<li>实现 <code v-pre>ByteToMessageDecoder</code> 字节转消息解码器。</li>
<li>重写 <code v-pre>decode</code> 解码方法。</li>
</ol>
...
<p>解码器最重要的，是对 <strong>ByteBuf</strong> 消息的读取，这个其实和正常消息读取也没啥区别。</p>
</blockquote>
<br/>
<h2 id="编码器" tabindex="-1"><a class="header-anchor" href="#编码器" aria-hidden="true">#</a> 编码器</h2>
<p>先说下 Java 序列化 Serializable，本来因为很少接触网络编程，基本就是转个json。确实不知道序列化有什么坑。</p>
<p>反正都知道是抄的，直接写结论吧：</p>
<ol>
<li><strong>Java 序列化最致命的问题是无法跨语言</strong>，所以在调用其他语言开发的应用时，就不能使用。</li>
<li>序列化后包太大，浪费资源。</li>
<li>序列化的性能太低，通俗讲就是序列化的速度慢</li>
</ol>
<hr>
<p>然后《Netty 权威指南》 推荐了几个编码器：<code v-pre>Google Protobuf</code> 、 <code v-pre>Facebook Thrift</code> 、<code v-pre>JBoss Marshalling</code></p>
<p>还特地开一章介绍了 <code v-pre>MessagePack</code> 编码器。</p>
<p>大体使用方式都差不多，都单独写个测试类，不介绍了，看跳转链接吧：</p>
<ul>
<li><a href="https://www.yuque.com/shiva/lct37n/uis8a1" target="_blank" rel="noopener noreferrer">MessagePack 编码器 · 语雀 (yuque.com)<ExternalLinkIcon/></a></li>
</ul>
<p>其他两个编码器，没见过，算了跳过</p>
<br/>
<h2 id="私有协议开发" tabindex="-1"><a class="header-anchor" href="#私有协议开发" aria-hidden="true">#</a> 私有协议开发</h2>
<p>Netty 可以用来实现各种网络协议，比如 HTTP、WebScoket 等。</p>
<ul>
<li><a href="https://www.yuque.com/shiva/lct37n/lz4af0" target="_blank" rel="noopener noreferrer">HTTP 协议开发应用 · 语雀 (yuque.com)<ExternalLinkIcon/></a></li>
</ul>
<p>但是实在是不明白应用场景是什么，略过好了，直接看私有协议。</p>
<blockquote>
<p>这一章就是定义一个私有协议，并且做代码实现。</p>
<p>其实就是把书里的代码都敲一遍。实际开发中的私有协议肯定是根据规范确定的。</p>
</blockquote>
<hr>
<h3 id="协议栈通信模型" tabindex="-1"><a class="header-anchor" href="#协议栈通信模型" aria-hidden="true">#</a> 协议栈通信模型</h3>
<p>所有的非标准协议，都可以被成为私有协议，即便是国家出的标准版行业协议。</p>
<p>我们先确定一个协议通信模型，然后再来做实现。</p>
<p>Netty 协议栈通信模型的流程可以参考：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/image-20220501215917933.png" alt=""></p>
<ol>
<li>Netty 协议栈客户端发送握手请求消息，携带节点 ID 等有效身份认证信息</li>
<li>Netty 协议栈服务端对握手请求消息进行合法性校验，包括节点ID有效性校验、节点重复登录校验和IP地址合法性校验，校验通过后，返回登录成功的握手应答消息;</li>
...
<br>
<h3 id="消息定义" tabindex="-1"><a class="header-anchor" href="#消息定义" aria-hidden="true">#</a> 消息定义</h3>
<p>消息格式定义分为消息头和消息体。</p>
<ul>
<li><strong>header</strong> ：消息头，变长；</li>
<li><strong>body</strong> ：消息体，变长；对于请求消息，它是方法的参数，对于响应消息，它是返回值</li>
</ul>
<h4 id="消息头格式" tabindex="-1"><a class="header-anchor" href="#消息头格式" aria-hidden="true">#</a> 消息头格式</h4>
<table>
<thead>
<tr>
<th>名称</th>
...
<td>int</td>
<td>32</td>
<td>消息长度，整个消息的长度。<strong>包括消息头和消息体。</strong></td>
</tr>
<tr>
<td>sessionID</td>
<td>long</td>
<td>64</td>
<td>集群节点内全局唯一，由会话ID生成器生成</td>
</tr>
<tr>
<td>type</td>
<td>byte</td>
...
<p><strong>crcCode</strong></p>
<p>定义校验码为：carCode = 固定值 + 主版本号 + 次版本号</p>
<ul>
<li>固定值：0xABEF ，占2个字节</li>
<li>主版本号：1-255，占1个字节</li>
<li>次版本号：1-255，占1个字节</li>
</ul>
<p><strong>type</strong></p>
<ul>
<li>0：业务消息请求</li>
<li>1：业务响应请求</li>
<li>2：业务 ONE WAY 消息，既是请求又是响应；意思应该是不需要响应</li>
<li>3：握手请求消息</li>
<li>4：握手应答消息</li>
<li>5：心跳请求消息</li>
<li>6：心跳应答消息</li>
...
<br>
<h3 id="可靠性设计" tabindex="-1"><a class="header-anchor" href="#可靠性设计" aria-hidden="true">#</a> 可靠性设计</h3>
<h4 id="心跳机制" tabindex="-1"><a class="header-anchor" href="#心跳机制" aria-hidden="true">#</a> 心跳机制</h4>
<p>心跳机制时序图如下。</p>
<blockquote>
<p><strong>当然不单单是客户端可以断开链接，如果服务端在N次没有收到心跳消息，也需要断开链接；</strong></p>
</blockquote>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/image-20220605144837465.png" alt=""></p>
<br>
<h4 id="重复登录保护" tabindex="-1"><a class="header-anchor" href="#重复登录保护" aria-hidden="true">#</a> 重复登录保护</h4>
<p>这个也没啥需要特殊解释的，就两点：</p>
<ol>
<li><strong>连接需要做身份校验；账号密码、IP白名单</strong></li>
<li><strong>校验当前的IP和账号是否已建立连接，检查缓存</strong></li>
</ol>
<br>
<h4 id="消息缓存重发" tabindex="-1"><a class="header-anchor" href="#消息缓存重发" aria-hidden="true">#</a> 消息缓存重发</h4>
<p>这个也好理解，弄个队列，缓存断开链接时的消息，链接建立后重新发送。</p>
<br/>
<h2 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> 参考文章</h2>
<ul>
<li><a href="https://www.pdai.tech/md/java/io/java-io-nio-netty.html" target="_blank" rel="noopener noreferrer">Java N(A)IO - 框架: Netty | Java 全栈知识体系 (pdai.tech)<ExternalLinkIcon/></a></li>
<li><a href="https://www.bilibili.com/video/BV1py4y1E7oA?p=53" target="_blank" rel="noopener noreferrer">黑马程序员Netty全套教程，全网最全Netty深入浅出教程，Java网络编程的王者_哔哩哔哩_bilibili<ExternalLinkIcon/></a></li>
<li><a href="https://www.cmsblogs.com/item/1114760968" target="_blank" rel="noopener noreferrer">Netty - Java 技术驿站 (cmsblogs.com)<ExternalLinkIcon/></a></li>
<li><a href="https://www.jianshu.com/nb/7269354" target="_blank" rel="noopener noreferrer">Netty源码分析 - 文集 - 简书 (jianshu.com)<ExternalLinkIcon/></a></li>
<li><a href="https://gitee.com/pic_bed_of_shiva/static-resources/blob/19cdedd5f020b7e2173d4c658114a52e0f0395fd/showns/file/%E9%BB%91%E9%A9%ACNetty%E6%95%99%E7%A8%8B%E6%BA%90%E7%A0%81%E8%B5%84%E6%96%99.rar" target="_blank" rel="noopener noreferrer">showns/file/黑马Netty教程源码资料.rar · Drawing Bed of First/static-resources - Gitee.com<ExternalLinkIcon/></a></li>
<li><a href="https://www.jianshu.com/p/975b30171352" target="_blank" rel="noopener noreferrer">Netty ChannelOption参数详解 - 简书 (jianshu.com)<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/u010144805/article/details/78579528" target="_blank" rel="noopener noreferrer">Socket中SO_REUSEADDR详解_明潮的博客-CSDN博客_reuseaddr<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/qq_28198181/article/details/82152338" target="_blank" rel="noopener noreferrer">channelOption中的属性了解_Gin_Chou的博客-CSDN博客<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/qq_33373609/article/details/120575389" target="_blank" rel="noopener noreferrer">Netty之启动类、编解码器等源码解析及粘包、拆包问题_踩踩踩从踩的博客-CSDN博客<ExternalLinkIcon/></a></li>
<li><a href="https://www.jianshu.com/p/3dfa2a9c1cc0" target="_blank" rel="noopener noreferrer">Netty源码分析——拆包器之LineBasedFrameDecoder - 简书 (jianshu.com)<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/weixin_38312719/article/details/108763753" target="_blank" rel="noopener noreferrer">(1条消息) LineBasedFrameDecoder解决粘包半包源码分析_star++的博客-CSDN博客_linebasedframedecoder半包原理<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/qq_45859054/article/details/115253892" target="_blank" rel="noopener noreferrer">解码器LengthFieldBasedFrameDecoder_书唐瑞的博客-CSDN博客<ExternalLinkIcon/></a></li>
<li><a href="https://www.jianshu.com/p/38a3546098ae" target="_blank" rel="noopener noreferrer">netty自定义解码器 decoder - 简书 (jianshu.com)<ExternalLinkIcon/></a></li>
</ul>
</div></template>
