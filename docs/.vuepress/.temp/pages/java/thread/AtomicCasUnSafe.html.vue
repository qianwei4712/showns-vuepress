...
<li><a href="#t1">CAS</a>
<ul>
<li><a href="#t11">CAS 使用示例</a></li>
<li><a href="#t12">CAS 问题缺陷</a></li>
</ul>
</li>
<li><a href="#t2">UnSafe 类</a></li>
<li><a href="#t3">AtomicInteger</a>
<ul>
<li><a href="#t31">底层结构</a></li>
<li><a href="#t32">主要方法</a></li>
<li><a href="#t33">addAndGet 详解</a></li>
<li><a href="#t34">解决 ABA 问题</a></li>
</ul>
</li>
<li><a href="#te">参考文章</a></li>
</ul>
</div>
<h2 id="原子类概述" tabindex="-1"><a class="header-anchor" href="#原子类概述" aria-hidden="true">#</a> <span id="t0">原子类概述</span></h2>
<blockquote>
<p>JUC 中多数类是通过 volatile 和 CAS 来实现的，CAS本质上提供的是一种无锁方案，而 Synchronized 和 Lock 是互斥锁方案。</p>
<p>java 原子类本质上使用的是 CAS，而 CAS 底层是通过 Unsafe 类实现的。</p>
</blockquote>
<p>线程安全的实现方法包含:</p>
<ul>
<li>互斥同步：<code v-pre>synchronized</code> 和 <code v-pre>ReentrantLock</code></li>
<li>非阻塞同步：<code v-pre>CAS</code> 、 <code v-pre>原子类AtomicXXXX</code></li>
<li>无同步方案:：<code v-pre>栈封闭</code> 、<code v-pre>Thread Local</code> 、可重入代码</li>
</ul>
<p>本篇主要讲述原子类，以及它所依赖的理论基础。</p>
<br/>
<h2 id="cas" tabindex="-1"><a class="header-anchor" href="#cas" aria-hidden="true">#</a> <span id="t1">CAS</span></h2>
<p><strong>CAS 的全称为 Compare-And-Swap，直译就是对比和交换。</strong></p>
<p>CAS 是一条 CPU 的原子指令，其作用是让 CPU 先进行比较两个值是否相等，然后原子地更新某个位置的值，经过调查发现，其实现方式是基于硬件平台的汇编指令，就是说 CAS 是靠硬件实现的，JVM 只是封装了汇编调用，那些 AtomicInteger 类便是使用了这些封装后的接口。</p>
<p>简单解释：</p>
<blockquote>
<p>CAS 操作需要输入两个数值，一个旧值(期望操作前的值)和一个新值，在操作期间先比较下在旧值有没有发生变化，如果没有发生变化，才交换成新值，发生了变化则不交换。</p>
</blockquote>
<p>CAS 操作是原子性的，所以多线程并发使用 CAS 更新数据时，可以不使用锁。JDK 中大量使用了 CAS 来更新数据而防止加锁（synchronized 重量级锁）来保持原子更新。</p>
<p><img src="http://shiva.oss-cn-hangzhou.aliyuncs.com/data/thread/CAS 比较替换流程示意图.png" alt="CAS 比较和替换流程示意图"></p>
<p>详细的后面再将再讲，先看用法。</p>
<br/>
<h3 id="cas-使用示例" tabindex="-1"><a class="header-anchor" href="#cas-使用示例" aria-hidden="true">#</a> <span id="t11">CAS 使用示例</span></h3>
<p>如果不使用 CAS，在高并发下，多线程同时修改一个变量的值我们需要 synchronized 加锁（可能有人说可以用 Lock 加锁，Lock 底层的 AQS 也是基于 CAS 进行获取锁的）。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>java 中为我们提供了 AtomicInteger 原子类（底层基于CAS进行更新数据的），不需要加锁就在多线程并发场景下实现数据的一致性。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test</span> <span class="token punctuation">{</span>
...
<h3 id="cas-问题缺陷" tabindex="-1"><a class="header-anchor" href="#cas-问题缺陷" aria-hidden="true">#</a> <span id="t12">CAS 问题缺陷</span></h3>
...
<p>ABA 问题的解决思路就是使用版本号。在变量前面追加上版本号，每次变量更新的时候把版本号加1，那么A-&gt;B-&gt;A就会变成1A-&gt;2B-&gt;3A。</p>
<p>从 Java 1.5 开始，JDK 的 Atomic 包里提供了一个类 <code v-pre>AtomicStampedReference</code> 来解决 ABA问题。</p>
<blockquote>
<p><strong>这个类的 compareAndSet 方法的作用是首先检查当前引用是否等于预期引用，并且检查当前标志是否等于预期标志，如果全部相等，则以原子方式将该引用和该标志的值设置为给定的更新值。</strong></p>
</blockquote>
<br/>
<h4 id="循环时间长开销大" tabindex="-1"><a class="header-anchor" href="#循环时间长开销大" aria-hidden="true">#</a> 循环时间长开销大</h4>
<p>自旋 CAS 如果长时间不成功，会给CPU带来非常大的执行开销。如果 JVM 能支持处理器提供的 pause 指令，那么效率会有一定的提升。</p>
<p>pause指令有两个作用：</p>
<ul>
...
<br/>
<h4 id="只能保证一个共享变量的原子操作" tabindex="-1"><a class="header-anchor" href="#只能保证一个共享变量的原子操作" aria-hidden="true">#</a> 只能保证一个共享变量的原子操作</h4>
<p>当对一个共享变量执行操作时，我们可以使用循环 CAS 的方式来保证原子操作，但是对多个共享变量操作时，循环 CAS 就无法保证操作的原子性，这个时候就可以用锁。</p>
<p>还有一个取巧的办法，就是把多个共享变量合并成一个共享变量来操作。比如，有两个共享变量i = 2，j = a，合并一下ij = 2a，然后用 CAS 来操作 ij 。</p>
<blockquote>
<p>从 Java 1.5 开始，JDK 提供了 AtomicReference 类来保证引用对象之间的原子性，就可以把多个变量放在一个对象里来进行 CAS 操作。</p>
</blockquote>
<p><img src="http://shiva.oss-cn-hangzhou.aliyuncs.com/emo/640.png" alt=""></p>
<br/>
<h2 id="unsafe-类" tabindex="-1"><a class="header-anchor" href="#unsafe-类" aria-hidden="true">#</a> <span id="t2">UnSafe 类</span></h2>
<p>上面已经提到了 UnSafe 类，可以看个例子。用的很多的 <code v-pre>AtomicInteger.addAndGet()</code> 方法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 设置使用 Unsafe.compareAndSwapInt 进行更新</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>基本所有的原子类都使用了 UnSafe 类来实现 CAS。</strong></p>
<p>下面简单介绍下 <strong>UnSafe</strong> 类，因为大多都是 <strong>native</strong> 方法，再深入我也不懂，只能简单介绍。</p>
<br/>
<h3 id="unsafe-与-cas" tabindex="-1"><a class="header-anchor" href="#unsafe-与-cas" aria-hidden="true">#</a> UnSafe 与 CAS</h3>
<p><strong>UnSafe 是 CAS 的核心类，因为 Java 方法无法直接访问操作系统，就需要 native 方法来操作，这就是 UnSafe 类的作用。</strong></p>
<p>UnSafe 的所有方法都是 native 方法。</p>
<p>它的作用如下图（感谢 <a href="https://tech.meituan.com/2019/02/14/talk-about-java-magic-class-unsafe.html" target="_blank">大佬</a> ）：</p>
<p><img src="http://shiva.oss-cn-hangzhou.aliyuncs.com/data/thread/UnSafe 类方法和作用.png" alt=""></p>
<br/>
<h2 id="atomicinteger" tabindex="-1"><a class="header-anchor" href="#atomicinteger" aria-hidden="true">#</a> <span id="t3">AtomicInteger</span></h2>
<p>基本所有的原子类都相似，下面用 <strong>AtomicInteger</strong> 类来举例说明。</p>
<br/>
<h3 id="底层结构" tabindex="-1"><a class="header-anchor" href="#底层结构" aria-hidden="true">#</a> <span id="t31">底层结构</span></h3>
<p><strong>AtomicInteger</strong>  底层由 <strong>UnSafe</strong> 来实现 CAS，其字段如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 设置使用 Unsafe.compareAndSwapInt 进行更新</span>
<span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">Unsafe</span> unsafe <span class="token operator">=</span> <span class="token class-name">Unsafe</span><span class="token punctuation">.</span><span class="token function">getUnsafe</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
<span class="token comment">// volatile 修饰的值，确保了  可见性</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>objectFieldOffset()</strong> 方法作用为：</p>
<blockquote>
<p><strong>获取某个字段相对 Java 对象的“起始地址”的偏移量。</strong> 可以近似认为 valueOffset 就是物理地址。</p>
</blockquote>
<br/>
<h3 id="主要方法" tabindex="-1"><a class="header-anchor" href="#主要方法" aria-hidden="true">#</a> <span id="t32">主要方法</span></h3>
<p><strong>AtomicInteger</strong>  的主要方法如下，作用也很明显了，大同小异。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>	<span class="token doc-comment comment">/**
     * <span class="token keyword">@return</span> 获得当前值
     */</span>
     ...
     * <span class="token keyword">@return</span> 之前的值
     */</span>
    ...
    <span class="token punctuation">}</span>
	<span class="token doc-comment comment">/**
     * 如果当前值 <span class="token punctuation">{</span><span class="token keyword">@code</span> <span class="token code-section"><span class="token code language-java"><span class="token operator">==</span></span></span><span class="token punctuation">}</span> 是预期值，则原子地将值设置为给定的更新值。
     * <span class="token keyword">@param</span> <span class="token parameter">expect</span> 期望值
     * <span class="token keyword">@param</span> <span class="token parameter">update</span> 新值
     * <span class="token keyword">@return</span> <span class="token punctuation">{</span><span class="token keyword">@code</span> <span class="token code-section"><span class="token code language-java"><span class="token boolean">true</span></span></span><span class="token punctuation">}</span> 如果成功。假返回表示实际值不等于预期值。
     */</span>
...
<h3 id="addandget-详解" tabindex="-1"><a class="header-anchor" href="#addandget-详解" aria-hidden="true">#</a> <span id="t33">addAndGet 详解</span></h3>
<p>抽一个来深入理解下。</p>
<p>首先，看下 <code v-pre>unsafe.getAndAddInt</code> 方法的源码：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上代码中，各参数表示：</p>
<ul>
<li><code v-pre>var1</code> ：当前对象本身，用于比较的对象</li>
<li><code v-pre>var2</code> ：偏移量，相当于引用地址。可以用于比较主内存中，值有没有变化，是不是和当前线程内的值相同。</li>
<li><code v-pre>var4</code> ：需要变动的数量。</li>
<li><code v-pre>var5</code> ：通过 <code v-pre>var1</code> 和 <code v-pre>var2</code> 获得的真实主内存中的值。</li>
</ul>
<p>貌似也不难理解是吧，毕竟也就两行代码。。。。</p>
<p><img src="http://shiva.oss-cn-hangzhou.aliyuncs.com/emo/XIKOEQKFKLOO3UE00.jpg" alt=""></p>
<p>比较简单，图也就不画了，简单写下步骤：</p>
<blockquote>
<ol>
<li>先根据 <code v-pre>对象var1</code> 和 <code v-pre>地址var2</code> ，获取内存中的 <code v-pre>真实值var5</code></li>
<li>比较 <code v-pre>真实值var5</code> 和 <code v-pre>对象自身值var1.value</code> ，如果相同，那就替换为 <code v-pre>真实值加变化量var5+var4</code></li>
<li>如果不同，<strong>因为  <code v-pre>对象自身值var1.value</code> 是用 <code v-pre>volatile</code> 修饰的，所以 <code v-pre>主内存真实值var5</code> 变化对 <code v-pre>对象var1</code> 是可见的。</strong></li>
<li>继续循环比较，直到相同并替换完成。</li>
<li>替换完成后，主内存的值替换为 <code v-pre>var5+var4</code> ， <code v-pre>unsafe.getAndAddInt</code> 仅返回了 <code v-pre>var5</code> ，所以 <code v-pre>addAndGet</code> 需要再加上 <code v-pre>var4</code> 。</li>
</ol>
</blockquote>
<br/>
<h3 id="解决-aba-问题" tabindex="-1"><a class="header-anchor" href="#解决-aba-问题" aria-hidden="true">#</a> <span id="t34">解决 ABA 问题</span></h3>
<p>在介绍 <code v-pre>AtomicStampedReference</code> 之前，我们先来看下 <code v-pre>AtomicReference</code> 原子引用的用法。</p>
<h4 id="atomicreference" tabindex="-1"><a class="header-anchor" href="#atomicreference" aria-hidden="true">#</a> AtomicReference</h4>
<p>其实也很简单。。。直接给个例子：</p>
...
<span class="token punctuation">}</span>
    ...
    <span class="token class-name">User</span> shiva <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">User</span><span class="token punctuation">(</span><span class="token string">"1"</span><span class="token punctuation">,</span> <span class="token string">"shiva"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token class-name">User</span> show <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">User</span><span class="token punctuation">(</span><span class="token string">"1"</span><span class="token punctuation">,</span> <span class="token string">"show"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    atomicReference<span class="token punctuation">.</span><span class="token function">set</span><span class="token punctuation">(</span>shiva<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token keyword">boolean</span> booleanFirst <span class="token operator">=</span> atomicReference<span class="token punctuation">.</span><span class="token function">compareAndSet</span><span class="token punctuation">(</span>shiva<span class="token punctuation">,</span> show<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"第一次比较替换结果: "</span> <span class="token operator">+</span> booleanFirst <span class="token operator">+</span> <span class="token string">", 当前原子引用的对象为： "</span> <span class="token operator">+</span> atomicReference<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token keyword">boolean</span> booleanSecond <span class="token operator">=</span> atomicReference<span class="token punctuation">.</span><span class="token function">compareAndSet</span><span class="token punctuation">(</span>shiva<span class="token punctuation">,</span> show<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"第二次比较替换结果: "</span> <span class="token operator">+</span> booleanSecond <span class="token operator">+</span> <span class="token string">", 当前原子引用的对象为： "</span> <span class="token operator">+</span> atomicReference<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行结果：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>第一次比较替换结果: true, 当前原子引用的对象为： User(id=1, name=show)
第二次比较替换结果: false, 当前原子引用的对象为： User(id=1, name=show)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>就不深入介绍了，没啥区别。。。</p>
<p><img src="http://shiva.oss-cn-hangzhou.aliyuncs.com/emo/unc/QQ图片20210605151038.jpg" alt=""></p>
<h4 id="atomicstampedreference" tabindex="-1"><a class="header-anchor" href="#atomicstampedreference" aria-hidden="true">#</a> AtomicStampedReference</h4>
<p>剩下就是最后的， <strong>AtomicStampedReference</strong> 类了。</p>
<p><code v-pre>AtomicStampedReference</code> 主要维护包含一个对象引用以及一个可以自动更新的整数&quot;stamp&quot;的 pair 对象来解决ABA问题。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AtomicStampedReference</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">V</span><span class="token punctuation">></span></span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">boolean</span> <span class="token function">compareAndSet</span><span class="token punctuation">(</span><span class="token class-name">V</span>   expectedReference<span class="token punctuation">,</span>
        ...
        <span class="token keyword">return</span>
            ...
            <span class="token comment">// 新引用等于旧引用</span>
            ...
            <span class="token comment">// 新版本号等于旧版本号</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token class-name">Thread</span> main <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Thread</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">-></span> <span class="token punctuation">{</span>
        ...
        <span class="token keyword">int</span> stamp <span class="token operator">=</span> asr<span class="token punctuation">.</span><span class="token function">getStamp</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//获取当前标识别</span>
        <span class="token keyword">try</span> <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span>
        <span class="token comment">//此时expectedReference未发生改变，但是stamp已经被修改了,所以CAS失败</span>
        <span class="token keyword">boolean</span> isCASSuccess <span class="token operator">=</span> asr<span class="token punctuation">.</span><span class="token function">compareAndSet</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> stamp<span class="token punctuation">,</span> stamp <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"操作线程"</span> <span class="token operator">+</span> <span class="token class-name">Thread</span><span class="token punctuation">.</span><span class="token function">currentThread</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token string">", CAS 操作结果: "</span> <span class="token operator">+</span> isCASSuccess <span class="token operator">+</span> <span class="token string">"， 版本="</span> <span class="token operator">+</span> asr<span class="token punctuation">.</span><span class="token function">getStamp</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <span class="token class-name">Thread</span> other <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Thread</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">-></span> <span class="token punctuation">{</span>
        <span class="token comment">// 让出资源，让其他线程优先执行</span>
        <span class="token class-name">Thread</span><span class="token punctuation">.</span><span class="token keyword">yield</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        asr<span class="token punctuation">.</span><span class="token function">compareAndSet</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> asr<span class="token punctuation">.</span><span class="token function">getStamp</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">,</span> asr<span class="token punctuation">.</span><span class="token function">getStamp</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"操作线程"</span> <span class="token operator">+</span> <span class="token class-name">Thread</span><span class="token punctuation">.</span><span class="token function">currentThread</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token string">", [increment]操作，值="</span> <span class="token operator">+</span> asr<span class="token punctuation">.</span><span class="token function">getReference</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token string">"， 版本="</span> <span class="token operator">+</span> asr<span class="token punctuation">.</span><span class="token function">getStamp</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        asr<span class="token punctuation">.</span><span class="token function">compareAndSet</span><span class="token punctuation">(</span><span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> asr<span class="token punctuation">.</span><span class="token function">getStamp</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">,</span> asr<span class="token punctuation">.</span><span class="token function">getStamp</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"操作线程"</span> <span class="token operator">+</span> <span class="token class-name">Thread</span><span class="token punctuation">.</span><span class="token function">currentThread</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token string">", [decrement]操作，值="</span> <span class="token operator">+</span> asr<span class="token punctuation">.</span><span class="token function">getReference</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token string">"， 版本="</span> <span class="token operator">+</span> asr<span class="token punctuation">.</span><span class="token function">getStamp</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>操作线程Thread[主操作线程,5,main],初始值 a = 1， 版本=0
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="http://shiva.oss-cn-hangzhou.aliyuncs.com/emo/QQ图片20210605155047.jpg" alt=""></p>
<br/>
<h2 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> <span id="te">参考文章</span></h2>
<p><a href="" target="_blank"></a></p>
<p><a href="https://www.bilibili.com/video/BV1pJ411M7mb?p=12" target="_blank">https://www.bilibili.com/video/BV1pJ411M7mb?p=12</a></p>
<p><a href="https://www.pdai.tech/md/java/thread/java-thread-x-juc-AtomicInteger.html" target="_blank">JUC原子类: CAS, Unsafe和原子类详解 | Java 全栈知识体系 (pdai.tech)</a></p>
<p><a href="https://blog.csdn.net/ls5718/article/details/52563959" target="_blank">Java中CAS详解_jayxu无捷之径的博客-CSDN博客_cas</a></p>
<p><a href="https://tech.meituan.com/2019/02/14/talk-about-java-magic-class-unsafe.html" target="_blank">Java魔法类：Unsafe应用解析 - 美团技术团队 (meituan.com)</a></p>
<p><a href="https://blog.csdn.net/blogs_broadcast/article/details/80672515" target="_blank">关于在AtomicInteger的static块中unsafe.objectFieldOffset干什么用的简介</a></p>
</div></template>
