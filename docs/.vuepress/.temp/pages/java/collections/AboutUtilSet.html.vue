...
<li><a href="#t1">Set 接口</a></li>
<li><a href="#t2">HashSet 源码</a></li>
<li><a href="#t3">TreeSet 源码</a>
<ul>
<li><a href="#t30">TreeSet 继承关系</a></li>
<li><a href="#t31">SortedSet、NavigableSet</a></li>
<li><a href="#t32">TreeSet 简单介绍</a></li>
</ul>
</li>
</ul>
</div>
<h3 id="概述" tabindex="-1"><a class="header-anchor" href="#概述" aria-hidden="true">#</a> <span id="t0">概述</span></h3>
<p>Java 集合接口听得最多的应该就是 List、Queue、Set、Map。</p>
<p>Set 的实现类重要的不多，而且源码也不复杂，甚至觉得没啥可讲的。</p>
<p>这一篇就汇总贴一下源码注释吧，也不过多介绍了： <strong>HashSet、TreeSet</strong></p>
<p>还是老规矩，先把源码放上：</p>
<ul>
<li>Set 接口源码：<a href="https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/Set.java" target="_blank">https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/Set.java</a></li>
<li>HashSet 源码：<a href="https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/HashSet.java" target="_blank">https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/HashSet.java</a></li>
<li>TreeSet 源码：<a href="https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/TreeSet.java" target="_blank">https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/TreeSet.java</a></li>
</ul>
<br>
<h3 id="set-接口" tabindex="-1"><a class="header-anchor" href="#set-接口" aria-hidden="true">#</a> <span id="t1">Set 接口</span></h3>
<p>首先说下 Set 接口设计的定义：</p>
<blockquote>
<p><strong>一个不包含重复元素的容器，即不满足 e1.equals(e2) 条件。</strong></p>
</blockquote>
<p>Set 接口的官方注释中有这么一句： <strong>如果允许 null，只允许存在一个 null</strong></p>
<p>作为一个接口，这里就列一下它的方法和设计要求，具体使用在实现类里讲解。</p>
<p><strong>查询操作</strong></p>
<table>
<thead>
<tr>
<th style="text-align:center">方法名/参数/返回值</th>
<th style="text-align:center">接口设计约束</th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align:center"><code v-pre>int size()</code></td>
<td style="text-align:center">返回此集合中的元素数。如果此集包含超过 Integer.MAX_VALUE，则返回 Integer.MAX_VALUE。</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>boolean isEmpty()</code></td>
<td style="text-align:center">如果集合不包含任何元素，则返回 true</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>boolean contains(Object o)</code></td>
<td style="text-align:center">如果此集合包含指定的元素，则返回 true。<br>更正式地讲，当且仅当此集合包含一个元素 e，使得（o == null？e == null：o 时，才返回 true）。</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>Iterator&lt;E&gt; iterator()</code></td>
<td style="text-align:center">返回此集合中元素的迭代器。元素以不特定的顺序返回（除非此集合是提供保证的某些类的实例）。</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>Object[] toArray()</code><br><code v-pre>&lt;T&gt; T[] toArray(T[] a)</code></td>
<td style="text-align:center">转数组</td>
</tr>
</tbody>
</table>
...
<td style="text-align:center">如果指定的元素尚不存在，则将其添加到该集合（可选操作）<br>更正式地讲，如果集合中不包含任何元素 e2 ，满足 e == null？e2 == null ：e.equals（e2）<br/>如果此集合已经包含元素，则调用将使该集合保持不变，并返回 false<br/>结合构造函数上的限制，可以确保集合永远不会包含重复元素</td>
</tr>
<tr>
<td style="text-align:center">boolean remove(Object o);</td>
<td style="text-align:center">如果存在指定的元素，则从该集合中删除（可选操作）<br/>更正式地讲，删除元素 e，满足 o == null？e == null：o.equals（e）<br/> 如果此集合包含元素，则返回 true（或者等效地，如果此集合作为调用结果更改）<br/> 一旦调用返回，此集合将不包含该元素。</td>
</tr>
</tbody>
</table>
...
<td style="text-align:center">判断包含全部</td>
</tr>
<tr>
<td style="text-align:center">boolean addAll(Collection&lt;? extends E&gt; c);</td>
<td style="text-align:center">批量添加</td>
</tr>
<tr>
<td style="text-align:center">boolean retainAll(Collection&lt;?&gt; c);</td>
<td style="text-align:center">删除差集</td>
</tr>
<tr>
<td style="text-align:center">boolean removeAll(Collection&lt;?&gt; c);</td>
<td style="text-align:center">删除交集</td>
</tr>
<tr>
<td style="text-align:center">void clear();</td>
<td style="text-align:center">删除所有元素，操作后集合为空</td>
</tr>
<tr>
<td style="text-align:center">boolean equals(Object o);</td>
<td style="text-align:center">两个集合具有相同的大小，指定集合的每个成员都包含在此集合中，则返回 true<br/>此定义确保 equals 方法可在 set 接口的不同实现中正常工作</td>
</tr>
<tr>
<td style="text-align:center">int hashCode();</td>
<td style="text-align:center">返回此集合的哈希码值<br>集合的哈希码定义为集合中元素的哈希码之和，其中 null 元素的哈希码为零。</td>
</tr>
</tbody>
</table>
<br>
<h3 id="hashset-源码" tabindex="-1"><a class="header-anchor" href="#hashset-源码" aria-hidden="true">#</a> <span id="t2">HashSet 源码</span></h3>
<p>HashSet 通过内部维护一个 HashMap 来实现。主要就以下几点：</p>
<ul>
<li>添加到 HashSet 的元素作为 HashMap 的 Key</li>
<li>所有 HashMap 的 Value 共用一个 <strong>static final</strong> 的 <strong>new Object</strong></li>
</ul>
<p>HashMap 源码可以看看以前写过的 ： <a href="https://blog.csdn.net/m0_46144826/article/details/106300438" target="_blank">https://blog.csdn.net/m0_46144826/article/details/106300438</a></p>
<p>实在没什么好讲的，贴下代码略过了。。。。</p>
...
<h3 id="treeset-源码" tabindex="-1"><a class="header-anchor" href="#treeset-源码" aria-hidden="true">#</a> <span id="t3">TreeSet 源码</span></h3>
<br>
<h4 id="treeset-继承关系" tabindex="-1"><a class="header-anchor" href="#treeset-继承关系" aria-hidden="true">#</a> <span id="t30">TreeSet 继承关系</span></h4>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/AboutUtilSet1.png" alt="AboutUtilSet1"></p>
<p>老规矩，稍微说下继承的几个类有啥作用：</p>
<ul>
<li>
...
<li>
<p><strong>AbstractSet</strong> 抽象类提供了 <strong>Set</strong> 的基础实现，是的 <strong>TreeSet</strong> 不需要从零开始实现一个 Set 的所有方法。当然，<strong>AbstractCollection</strong> 也一样。</p>
</li>
<li>
<p>然后剩下的 <strong>NavigableSet</strong> 和 <strong>SortedSort</strong> 实现了元素的比较，确定优先级，后面再详细讲。</p>
</li>
</ul>
<br>
<h4 id="sortedset、navigableset" tabindex="-1"><a class="header-anchor" href="#sortedset、navigableset" aria-hidden="true">#</a> <span id="t31">SortedSet、NavigableSet</span></h4>
<p>先把代码注释放上：</p>
<ul>
<li>
<p>SortedSet 接口源码 ：<a href="https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/SortedSet.java" target="_blank">https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/SortedSet.java</a></p>
</li>
<li>
<p>NavigableSet 接口源码 ：<a href="https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/NavigableSet.java" target="_blank">https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/NavigableSet.java</a></p>
</li>
</ul>
<p><strong>SortedSet</strong> 是 <strong>NavigableSet</strong> 的父类。</p>
<p><strong>SortedSet</strong> 是一个自动排序不重复的 Collection 集合，接口设计要求实现一个 <strong>comparator</strong> 比较器，如果没有实现，则使用元素自带的比较器。</p>
<font color="red">**所以集合内泛型元素必须实现 Comparable 接口**</font><p><strong>NavigableSet</strong> 在 <strong>SortedSet</strong> 基础上进行了一些功能增强，具体功能见下表：</p>
<p><strong>SortedSet 接口方法：</strong></p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:center"><code v-pre>Comparator&lt;? super E&gt; comparator()</code></td>
<td style="text-align:center">返回本 SortedSet 的比较器，如果使用自然排序则返回 null</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>SortedSet&lt;E&gt; subSet(E fromElement, E toElement)</code></td>
<td style="text-align:center">返回此集合部分的视图，其元素范围从<tt>fromElement</tt>（包括）到<tt>toElement</tt>（不包括）。</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>SortedSet&lt;E&gt; headSet(E toElement)</code></td>
<td style="text-align:center">此集合的一部分的视图，其元素严格小于<tt>toElement</tt></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>SortedSet&lt;E&gt; tailSet(E fromElement)</code></td>
<td style="text-align:center">此集合中元素大于或等于<tt>fromElement</tt>的部分的视图</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>E first()</code></td>
<td style="text-align:center">返回当前 set 中第一个（最小）节点</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>E last()</code></td>
<td style="text-align:center">返回当前 set 中最后（最大）一个节点</td>
</tr>
</tbody>
</table>
<p><strong>NavigableSet 接口添加的方法：</strong></p>
<table>
<thead>
<tr>
<th style="text-align:center">方法、参数、返回值</th>
...
<tbody>
<tr>
<td style="text-align:center">E lower(E e);</td>
<td style="text-align:center">返回此 set 中严格小于给定元素的最大元素；如果不存在这样的元素，则返回 null。</td>
</tr>
<tr>
<td style="text-align:center">E floor(E e);</td>
<td style="text-align:center">返回此 set 中小于等于给定元素的最大元素；如果不存在这样的元素，则返回 null。</td>
</tr>
<tr>
<td style="text-align:center">E ceiling(E e);</td>
<td style="text-align:center">返回此 set 中大于等于给定元素的最小元素；如果不存在这样的元素，则返回 null。</td>
</tr>
<tr>
<td style="text-align:center">E higher(E e);</td>
<td style="text-align:center">返回此 set 中严格大于给定元素的最小元素；如果不存在这样的元素，则返回 null。</td>
</tr>
<tr>
<td style="text-align:center">E pollFirst();</td>
<td style="text-align:center">获取并移除第一个（最小）元素；如果此 set 为空，则返回 null。</td>
</tr>
<tr>
<td style="text-align:center">E pollLast();</td>
<td style="text-align:center">获取并移除最后一个（最大）元素；如果此 set 为空，则返回 null。</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>Iterator&lt;E&gt;</code> iterator();</td>
<td style="text-align:center">以升序返回在此 set 的元素上进行迭代的迭代器。</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>NavigableSet&lt;E&gt;</code> descendingSet();</td>
<td style="text-align:center">返回此 set 中所包含元素的逆序视图。</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>Iterator&lt;E&gt;</code> descendingIterator();</td>
<td style="text-align:center">以降序返回在此 set 的元素上进行迭代的迭代器。</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>NavigableSet&lt;E&gt;</code> subSet(E fromElement, boolean fromInclusive, E toElement, boolean toInclusive);</td>
<td style="text-align:center">返回此 set 的部分视图，其元素范围从 fromElement 到 toElement。根据 fromInclusive 和 toInclusive 判断是否包含边界。</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>NavigableSet&lt;E&gt;</code> headSet(E toElement, boolean inclusive);</td>
<td style="text-align:center">返回此 set 的部分视图，其元素范围从开始到 toElement。根据 toInclusive 判断是否包含边界。</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>NavigableSet&lt;E&gt;</code> tailSet(E fromElement, boolean inclusive);</td>
<td style="text-align:center">返回此 set 的部分视图，其元素范围从 fromElement 到结束。根据 fromInclusive 判断是否包含边界。</td>
</tr>
</tbody>
</table>
<br>
<h4 id="treeset-简单介绍" tabindex="-1"><a class="header-anchor" href="#treeset-简单介绍" aria-hidden="true">#</a> <span id="t32">TreeSet 简单介绍</span></h4>
<p>TreeSet 和 HashSet 一样，都是都是通过适配器模式完成。</p>
<p>通过内部维护一个 NavigableMap 来实现。主要就以下几点：</p>
<ul>
<li>添加到 TreeSet 的元素作为 NavigableMap 的 Key</li>
<li>所有 NavigableMap 的 Value 共用一个 <strong>static final</strong> 的 <strong>new Object</strong></li>
</ul>
<p>代码实现其实和上面的 HashSet 一样。。我就不贴了。。</p>
<p>这里顺便提下，TreeSet 使用 NavigableMap 最为参数，而不是 TreeMap 。</p>
<p>很明显的，使用接口作为参数，可以增加程序的扩展性，所有实现接口的类都可以传入。</p>
</div></template>
