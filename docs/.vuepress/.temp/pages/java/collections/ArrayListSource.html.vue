...
<ul>
<li><a href="#t1">概述</a></li>
<li><a href="#t2">继承关系</a></li>
<li><a href="#t3">构造方法</a></li>
<li><a href="#t4">ArrayList 的常用方法</a>
<ul>
<li><a href="#t41">addAll</a></li>
<li><a href="#t42">removeAll</a></li>
<li><a href="#t43">iterator</a></li>
<li><a href="#t44">subList</a></li>
<li><a href="#t45">ensureCapacityInternal</a></li>
<li><a href="#t46">modCount 简介</a></li>
</ul>
</li>
<li><a href="#t5">使用建议</a></li>
<li><a href="#t6">参考文章</a></li>
</ul>
</div>
<h3 id="概述" tabindex="-1"><a class="header-anchor" href="#概述" aria-hidden="true">#</a> <span id="t1">概述</span></h3>
<p>阅读 Java 版本为 <strong>1.8.0.25</strong>。</p>
<p><em>ArrayList</em> 实现了 <em>List</em> 接口，是顺序容器，即元素存放的数据与放进去的顺序相同，允许放入 <code v-pre>null</code> 元素，底层通过<strong>Object 数组实现</strong>。</p>
<p>除该类未实现同步外，其余跟 <em>Vector</em> 大致相同。每个 <em>ArrayList</em> 都有一个容量(capacity)，表示底层数组的实际大小，容器内存储元素的个数不能多于当前容量。当向容器中添加元素时，如果容量不足，容器会自动增大底层数组的大小。</p>
<p>学习方式为，将 <strong>ArrayList</strong> 源码以及相关类拷贝至自定义包内，进行注释添加，代码请移步：<br>
<a href="https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/ArrayList.java" target="_blank">https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/ArrayList.java</a></p>
<p>知识点总结如下：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/ArrayListSource1.png" alt="ArrayListSource1"></p>
<br>
<h3 id="继承关系" tabindex="-1"><a class="header-anchor" href="#继承关系" aria-hidden="true">#</a> <span id="t2">继承关系</span></h3>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/ArrayListSource2.png" alt="ArrayListSource2"></p>
<ul>
<li>实现 <strong>Serializable</strong> 接口开启序列化功能 ----具体介绍请转 <strong>Java 面向对象基础 - 异常、序列化</strong></li>
<li>实现 <strong>Cloneable</strong> 接口，允许使用 <strong>clone()</strong> 方法克隆 --- 具体介绍请转 <strong>Java 面向对象基础 - Object 通用方法、枚举</strong></li>
<li>实现 <strong>RandomAccess</strong> 接口，支持快速随机访问策略（官网说明，如果是实现了这个接口的  <strong>List</strong>，那么使用 for 循环的方式获取数据会优于用迭代器 Iterator 获取数据） --- 具体请参考文章
<a href="https://www.cnblogs.com/yeya/p/9950723.html" target="_blank">https://www.cnblogs.com/yeya/p/9950723.html</a></li>
</ul>
<br>
<h3 id="构造方法" tabindex="-1"><a class="header-anchor" href="#构造方法" aria-hidden="true">#</a> <span id="t3">构造方法</span></h3>
<p>ArrayList 底层如下，经有 2 个字段，底层基于数组实现。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//底层基于 Object[] 实现，可以存储所有类型。</span>
    ...
    <span class="token comment">//列表长度,并不是Object[]的长度，而是实际列表元素的个数</span>
    <span class="token keyword">private</span> <span class="token keyword">int</span> size<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>ArrayList 静态常量如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//默认初始化容量</span>
    ...
    <span class="token comment">//默认空list，当构造方法传入长度为0时返回</span>
    ...
    <span class="token comment">//默认空list，无参构造器时返回的默认列表</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
    ...
    <span class="token comment">//无参构造方法，默认返回空列表</span>
    ...
    <span class="token keyword">public</span> <span class="token class-name">ArrayList</span><span class="token punctuation">(</span><span class="token class-name">Collection</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span> <span class="token keyword">extends</span> <span class="token class-name">E</span><span class="token punctuation">></span></span> c<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token punctuation">(</span>size <span class="token operator">=</span> elementData<span class="token punctuation">.</span>length<span class="token punctuation">)</span> <span class="token operator">!=</span> <span class="token number">0</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
            <span class="token keyword">if</span> <span class="token punctuation">(</span>elementData<span class="token punctuation">.</span><span class="token function">getClass</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">!=</span> <span class="token class-name">Object</span><span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">)</span>
                <span class="token comment">// c.toArray() 返回的数组类型不是 Object[]，则利用 Arrays.copyOf()来构造一个大小为 size 的 Object[] 数组</span>
        ...
        <span class="token punctuation">}</span> <span class="token keyword">else</span> <span class="token punctuation">{</span>
            <span class="token comment">//集合参数长度为0，设置为默认列表</span>
            <span class="token keyword">this</span><span class="token punctuation">.</span>elementData <span class="token operator">=</span> <span class="token constant">EMPTY_ELEMENTDATA</span><span class="token punctuation">;</span>
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br>
<h3 id="arraylist-的常用方法" tabindex="-1"><a class="header-anchor" href="#arraylist-的常用方法" aria-hidden="true">#</a> <span id="t4">ArrayList 的常用方法</span></h3>
<p>同一类型方法都大同小异，这里都抽一个解释一下。</p>
<p><code v-pre>indexOf(Object o)、get(int index)、contains(Object o)</code> 等方法虽然很常用，但是代码实现特别简单，就不贴出来了。</p>
<br>
<h4 id="addall-int-index-collection-extends-e-c" tabindex="-1"><a class="header-anchor" href="#addall-int-index-collection-extends-e-c" aria-hidden="true">#</a> <span id="t41">addAll(int index, Collection&lt;? extends E&gt; c)；</span></h4>
<p>添加方法共有四种：</p>
<ul>
<li>add(E e)，末尾添加一个元素</li>
<li>add(int index, E element)，在指定位置添加元素</li>
<li>addAll(Collection&lt;? extends E&gt; c)，顺序批量添加</li>
<li>addAll(int index, Collection&lt;? extends E&gt; c)，从指定位置开始批量添加</li>
</ul>
<p>内部实现比较简单，例如这里最复杂的第四个：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">// 从指定位置开始批量添加</span>
    <span class="token keyword">public</span> <span class="token keyword">boolean</span> <span class="token function">addAll</span><span class="token punctuation">(</span><span class="token keyword">int</span> index<span class="token punctuation">,</span> <span class="token class-name">Collection</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span> <span class="token keyword">extends</span> <span class="token class-name">E</span><span class="token punctuation">></span></span> c<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token comment">// 将需添加集合转为数组</span>
        ...
        <span class="token comment">// 需要添加的个数</span>
        ...
        <span class="token comment">//确定数组长度，长度如果添加 numNew,是否需要扩容</span>
        ...
        <span class="token comment">//获得开始移动的下标，使用 native 方法进行赋值移动</span>
        ...
        <span class="token comment">// 将需要添加的数组拷贝到列表数组</span>
        ...
        <span class="token comment">// 数组长度更改</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里涉及到 2 个私有方法，<strong>ensureCapacityInternal</strong> 是个特殊方法，后面专门介绍；<strong>rangeCheckForAdd</strong> 比较简单，贴个代码过去了。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">// 判断指定位置是否超出列表位置范围</span>
    ...
    <span class="token comment">// 编写异常信息</span>
...
<h4 id="removeall-collection-c" tabindex="-1"><a class="header-anchor" href="#removeall-collection-c" aria-hidden="true">#</a> <span id="t42">removeAll(Collection&lt;?&gt; c)</span></h4>
<p>涉及移除的方法有：</p>
<ul>
<li>remove(int index)，根据数组下标删除</li>
<li>remove(Object o)，根据元素对象删除，只删除第一个</li>
<li>removeRange(int fromIndex, int toIndex)，根据数组下标范围删除</li>
<li>removeAll(Collection&lt;?&gt; c)，根据集合批量删除，移除 list 中和 c 中共有的元素</li>
<li>retainAll(Collection&lt;?&gt; c)，只保留 list 和 集合 c 中公有的元素：和 removeAll() 功能相反</li>
<li>removeIf(Predicate&lt;? super E&gt; filter)，1.8 开始加入的新方法，根据条件删除</li>
<li>clear()，清空列表</li>
</ul>
<p>这里最常用的应该是 <strong>remove(Object o)</strong> ，不过比较简单，就不展开了。</p>
<p>介绍一下复杂的，比如 <strong>removeAll(Collection&lt;?&gt; c)</strong> 代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">// 根据集合批量删除, 移除 list 中和 c 中共有的元素</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重点是下面的批量删除方法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">// 批量删除，true-保留并集，false-保留差集</span>
    <span class="token keyword">private</span> <span class="token keyword">boolean</span> <span class="token function">batchRemove</span><span class="token punctuation">(</span><span class="token class-name">Collection</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span><span class="token punctuation">></span></span> c<span class="token punctuation">,</span> <span class="token keyword">boolean</span> complement<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">// 重新创建一个数组保存原数组</span>
        ...
        <span class="token keyword">try</span> <span class="token punctuation">{</span>
            <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token punctuation">;</span> r <span class="token operator">&lt;</span> size<span class="token punctuation">;</span> r<span class="token operator">++</span><span class="token punctuation">)</span>
                <span class="token comment">// 如果 c 包含原数组元素并且模式为保留并集，将该元素赋值到新数组</span>
                <span class="token comment">// 如果 c 不含原数组元素并且模式为差集，将该元素赋值到新数组</span>
        ...
        <span class="token punctuation">}</span> <span class="token keyword">finally</span> <span class="token punctuation">{</span>
            <span class="token comment">//这个if，官方的注释是为了保持和AbstractCollection的兼容性</span>
            <span class="token comment">//假如上面c.contains抛出了异常，导致for循环终止，那么必然会导致r != size</span>
            <span class="token comment">//所以0-w之间是需要保留的数据，同时从w索引开始将剩下没有循环的数据(也就是从r开始的)拷贝回来，也保留</span>
            ...
            <span class="token punctuation">}</span>
            <span class="token comment">//for循环完毕，检测了所有的元素，0-w之间保存了需要留下的数据，w开始以及后面的数据全部清空</span>
...
<h4 id="iterator" tabindex="-1"><a class="header-anchor" href="#iterator" aria-hidden="true">#</a> <span id="t43">iterator()</span></h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token keyword">public</span> <span class="token class-name">Iterator</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">E</span><span class="token punctuation">></span></span> <span class="token function">iterator</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>迭代器用的太多了，多的也不介绍了，稍微贴几段代码得了</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>   <span class="token keyword">private</span> <span class="token keyword">class</span> <span class="token class-name">Itr</span> <span class="token keyword">implements</span> <span class="token class-name">Iterator</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">E</span><span class="token punctuation">></span></span> <span class="token punctuation">{</span>
        <span class="token comment">// 标记字段，达到指针效果</span>
        ...
        <span class="token comment">// 记录变化值，简单的线程安全判断</span>
        ...
        <span class="token comment">// 简单的线程安全判断，快速失败机制</span>
...
<h4 id="sublist-int-fromindex-int-toindex" tabindex="-1"><a class="header-anchor" href="#sublist-int-fromindex-int-toindex" aria-hidden="true">#</a> <span id="t44">subList(int fromIndex, int toIndex)</span></h4>
<p>截取列表方法，实际上返回内部类 <code v-pre>SubList</code> ，这个内部类和 <code v-pre>ArrayList</code> 一样继承了 <code v-pre>AbstractList</code> ，截取方法如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">// 截取list</span>
    <span class="token keyword">public</span> <span class="token class-name">List</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">E</span><span class="token punctuation">></span></span> <span class="token function">subList</span><span class="token punctuation">(</span><span class="token keyword">int</span> fromIndex<span class="token punctuation">,</span> <span class="token keyword">int</span> toIndex<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">//判断下标是否符合</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>SubList</code> 源码过长，贴一下要点：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>   <span class="token keyword">private</span> <span class="token keyword">class</span> <span class="token class-name">SubList</span> <span class="token keyword">extends</span> <span class="token class-name">AbstractList</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">E</span><span class="token punctuation">></span></span> <span class="token keyword">implements</span> <span class="token class-name">RandomAccess</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>实际上 <strong>subList(int fromIndex, int toIndex)</strong> 是将原 <strong>ArrayList</strong> 作为一个字段维护进 <code v-pre>SubList</code> 中，因为也实现了 List 接口，所有其他操作不变。</p>
<p>并且，所有针对返回结果的操作，都继续反映在原数组上。</p>
<blockquote>
<p><strong>subList(int fromIndex, int toIndex)</strong> 返回的已经不是 <code v-pre>ArrayList</code> 了，实际编码中可以观察到，代码自动补全后返回类型为 List，不可向下转为 <code v-pre>ArrayList</code> 。** 以前还真没发现。。。。</p>
</blockquote>
<br>
<h4 id="ensurecapacityinternal-int-mincapacity" tabindex="-1"><a class="header-anchor" href="#ensurecapacityinternal-int-mincapacity" aria-hidden="true">#</a> <span id="t45">ensureCapacityInternal(int minCapacity)</span></h4>
<p>这是一个数组扩容方法，首先判断扩容一半是否足够，若不够则直接扩容至结果长度（原长度+添加个数），了解一下就行了，个人感觉用不太上。</p>
<p>具体解析如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code> <span class="token comment">// 扩容数组，判断是否为默认空数组</span>
    <span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">ensureCapacityInternal</span><span class="token punctuation">(</span><span class="token keyword">int</span> minCapacity<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">//如果当前数组为默认空数组，扩容数组长度，最小为10</span>
    ...
    <span class="token comment">// 修改计数，判断是否需要增加数组长度</span>
    <span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">ensureExplicitCapacity</span><span class="token punctuation">(</span><span class="token keyword">int</span> minCapacity<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">// 操作计数，此参数继承自 AbstractList，用来记录列表的增删操作次数</span>
        <span class="token comment">// 实际作用为，在线程不安全的对象中，进行简单的线程安全判断。</span>
        modCount<span class="token operator">++</span><span class="token punctuation">;</span>
        <span class="token comment">// 如果需求长度大于当前数组长度，进行扩容</span>
        <span class="token keyword">if</span> <span class="token punctuation">(</span>minCapacity <span class="token operator">-</span> elementData<span class="token punctuation">.</span>length <span class="token operator">></span> <span class="token number">0</span><span class="token punctuation">)</span>
            <span class="token function">grow</span><span class="token punctuation">(</span>minCapacity<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>

    <span class="token comment">// 实际扩容方法，</span>
    <span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">grow</span><span class="token punctuation">(</span><span class="token keyword">int</span> minCapacity<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">int</span> oldCapacity <span class="token operator">=</span> elementData<span class="token punctuation">.</span>length<span class="token punctuation">;</span>
        <span class="token comment">// 运算符 >> 是带符号右移. 如 oldCapacity = 10,则 newCapacity = 10 + (10 >> 1) = 10 + 5 = 15</span>
        <span class="token keyword">int</span> newCapacity <span class="token operator">=</span> oldCapacity <span class="token operator">+</span> <span class="token punctuation">(</span>oldCapacity <span class="token operator">>></span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token keyword">if</span> <span class="token punctuation">(</span>newCapacity <span class="token operator">-</span> minCapacity <span class="token operator">&lt;</span> <span class="token number">0</span><span class="token punctuation">)</span>
            <span class="token comment">// 若 newCapacity 依旧小于 minCapacity，直接赋值</span>
        ...
        <span class="token keyword">if</span> <span class="token punctuation">(</span>newCapacity <span class="token operator">-</span> <span class="token constant">MAX_ARRAY_SIZE</span> <span class="token operator">></span> <span class="token number">0</span><span class="token punctuation">)</span>
            <span class="token comment">// 若超出最大长度，直接赋值为最大值</span>
            newCapacity <span class="token operator">=</span> <span class="token function">hugeCapacity</span><span class="token punctuation">(</span>minCapacity<span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token comment">// 重新创建指定长度的数组，并将原数组复制过去</span>
...
<h4 id="modcount-简介" tabindex="-1"><a class="header-anchor" href="#modcount-简介" aria-hidden="true">#</a> <span id="t46">modCount 简介</span></h4>
<p>该字段是父类 <code v-pre>AbstractList </code> 的一个 <code v-pre>protected  </code> 类型字段。</p>
<p>在 ArrayList 的所有涉及结构变化的方法中都增加 modCount 的值，包括：add()、remove()、addAll()、removeRange()、clear()等方法。</p>
<p>这些涉及到列表增删的方法每调用一次，modCount 的值就加 1。</p>
<p>这里简单介绍下 <code v-pre>modCount</code> 在 <code v-pre>ArrayList</code> 的作用，例如 sort() 方法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//带比较器的排序方法</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">sort</span><span class="token punctuation">(</span><span class="token class-name">Comparator</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span> <span class="token keyword">super</span> <span class="token class-name">E</span><span class="token punctuation">></span></span> c<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">//记录原本更改次数</span>
        ...
        <span class="token comment">//如果在排序过程中，其他线程对list进行了增删操作，导致 modCount 会发生变化， 然后丢出异常</span>
...
<p>从上面代码可以得出，<code v-pre>modCount</code> 只能简单的判断。</p>
<p><strong>如果排序过程中，进行了添加或者移除的操作，那么 <code v-pre>modCount</code> 不等于 <code v-pre>expectedModCount</code> ，数组元素已经产生了变化。这是有问题的，所以 <code v-pre>ArrayList</code> 并不是线程安全的。</strong></p>
</blockquote>
<br>
<h3 id="使用建议" tabindex="-1"><a class="header-anchor" href="#使用建议" aria-hidden="true">#</a> <span id="t5">使用建议</span></h3>
<p>其实也没啥可建议的，也就是：</p>
<ul>
<li>根据数组的特点，对于增删操作少的情况下建议使用</li>
<li>根据扩容的原理，粗略估计有多少元素，构造时确定长度，以免扩容操作重新复制</li>
</ul>
<br>
<h3 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> <span id="t6">参考文章</span></h3>
<p><a href="https://blog.csdn.net/GuLu_GuLu_jp/article/details/51456969" target="_blank">https://blog.csdn.net/GuLu_GuLu_jp/article/details/51456969</a></p>
<p><a href="https://www.pdai.tech/md/java/collection/java-collection-ArrayList.html" target="_blank">https://www.pdai.tech/md/java/collection/java-collection-ArrayList.html</a></p>
<p><a href="https://www.cnblogs.com/yeya/p/9950723.html" target="_blank">https://www.cnblogs.com/yeya/p/9950723.html</a></p>
<p><a href="https://blog.csdn.net/Kate_sicheng/article/details/77616204" target="_blank">https://blog.csdn.net/Kate_sicheng/article/details/77616204</a></p>
<p><a href="https://blog.csdn.net/liuzhaomin/article/details/83917923" target="_blank">https://blog.csdn.net/liuzhaomin/article/details/83917923</a></p>
<p><a href="https://blog.csdn.net/eson_15/article/details/51121833" target="_blank">https://blog.csdn.net/eson_15/article/details/51121833</a></p>
<p><a href="https://www.cnblogs.com/zt007/p/11080811.html" target="_blank">https://www.cnblogs.com/zt007/p/11080811.html</a></p>
</div></template>
