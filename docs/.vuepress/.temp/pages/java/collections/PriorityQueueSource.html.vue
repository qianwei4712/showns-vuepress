...
<li><a href="#t11">堆的简单介绍</a></li>
<li><a href="#t2">PriorityQueue构造方法</a></li>
<li><a href="#t3">PriorityQueue的常用方法</a>
<ul>
<li><a href="#t31">add(E e) 和 offer(E e)</a></li>
<li><a href="#t32">poll()</a></li>
<li><a href="#t33">grow() 扩容</a></li>
</ul>
</li>
<li><a href="#t4">使用建议</a></li>
...
<p><strong>PriorityQueue</strong> 即优先队列，也是一个非常重要的队列实现形式，通过堆实现。</p>
<p><strong>优先队列的作用是能保证每次取出的元素都是队列中权值最小的</strong>(Java的优先队列每次取最小元素)。这里牵涉到了大小关系，<strong>元素大小的评判可以通过元素本身的自然顺序(natural ordering)，也可以通过构造时传入的比较器</strong>(<em>Comparator</em>)。</p>
<p>然后说下，在排序算法中，有一个高效并且消耗内存少的排序方法 -- 堆排序。堆排序算法应该是网上到处都是，可以自行百度。</p>
<p>还是和以前一样，将 <strong>PriorityQueue</strong> 源码以及相关类拷贝至自定义包内，进行注释添加，代码请移步：<br>
<a href="https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/PriorityQueue.java" target="_blank">https://gitee.com/qianwei4712/JDK1.8.0.25-read/blob/master/src/main/java/java/util/PriorityQueue.java</a></p>
<p>知识点总结如下：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/PriorityQueueSource1.png" alt="PriorityQueueSource1"></p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/PriorityQueueSource2.png" alt="PriorityQueueSource2"></p>
<br>
<h3 id="堆的简单介绍" tabindex="-1"><a class="header-anchor" href="#堆的简单介绍" aria-hidden="true">#</a> <span id="t11">堆的简单介绍</span></h3>
<p>堆有2个概念：第一个是内存里面的堆，也就是静态链表；第二个堆是数据结构里的 <strong>二叉堆BinaryHeap</strong>，JDK 里表现为 <strong>PriorityQueue</strong> 优先队列  。</p>
<p>Java 中 <em>PriorityQueue</em> 通过堆实现，具体说是通过完全二叉树(<em>complete binary tree</em>)实现的<strong>小顶堆</strong> ，然后是最小堆的定义：</p>
<ol>
<li>是一个完全二叉树</li>
<li>任意节点的值小于等于左右两个孩子的值（如果有）</li>
<li>任意非叶子节点的左右子树也都是堆</li>
</ol>
<p>堆的下标关系：</p>
<ol>
<li>根节点下标为0</li>
...
<p>堆是一个典型的，<span style="color:red;"><strong>用物理上线性表示逻辑上非线性的数据结构</strong></span> ，例如下面这个例子的下标排列顺序</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/PriorityQueueSource3.png" alt="PriorityQueueSource3"></p>
<br>
<h3 id="priorityqueue构造方法" tabindex="-1"><a class="header-anchor" href="#priorityqueue构造方法" aria-hidden="true">#</a> <span id="t2">PriorityQueue构造方法</span></h3>
<p>PriorityQueue 底层字段如下，经有4个字段，底层基于数组实现。</p>
<p>modCount 字段在 ArrayList 中做了详细解释，原本是 AbstractList 的 protected 字段。不过 PriorityQueue 没继承，就定义了一个，用于线程不安全情况下的快速失败判断机制。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//底层使用数组实现</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>PriorityQueue 静态常量如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//默认初始容量</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>PriorityQueue 的构造方法是我目前知道的最多的，有7个构造方法。。</p>
<p>因为 PriorityQueue 我基本没用过。。只能凭个人感觉哪些构造方法比较重要贴下了。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//无参构造器，默认数组长度 11；无比较器，元素按照顺序排序</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><span style="color:red;"><strong>无参构造器，默认数组长度 11</strong></span></p>
<p>上面这套构造方法是基础的根据参数来构造对象。然后是根据其他 Collection 类创建</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//根据 Collection集合 创建优先队列</span>
...
<p>构造方法中的几个调用细节在下面 具体操作时候再讲，包括堆排序，其实感觉根据有序集合构造的情况应该不多。。。</p>
<br>
<h3 id="priorityqueue的常用方法" tabindex="-1"><a class="header-anchor" href="#priorityqueue的常用方法" aria-hidden="true">#</a> <span id="t3">PriorityQueue的常用方法</span></h3>
<p>PriorityQueue 是一个队列，队列的方法以前介绍过，不过 PriorityQueue 不是一个正常的先进先出队列。</p>
<br>
<h4 id="add-e-e-和-offer-e-e" tabindex="-1"><a class="header-anchor" href="#add-e-e-和-offer-e-e" aria-hidden="true">#</a> <span id="t31">add(E e) 和 offer(E e)</span></h4>
<p>先看看添加元素方法的代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//将指定的元素插入此优先队列</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>首先这里可以看出</p>
<p><span style="color:red;"><strong>PriorityQueue 不允许添加 null。</strong></span></p>
<p>然后就是，空队列第一个元素位置是 queue[0] 位置。然后是元素筛选的逻辑：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后再看自然比较，就是使用存储对象自带的比较器</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//没有比较器，使用自然比较</span>
    <span class="token annotation punctuation">@SuppressWarnings</span><span class="token punctuation">(</span><span class="token string">"unchecked"</span><span class="token punctuation">)</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后这里看下第一句强转</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code> <span class="token class-name">Comparable</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span> <span class="token keyword">super</span> <span class="token class-name">E</span><span class="token punctuation">></span></span> key <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token class-name">Comparable</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span> <span class="token keyword">super</span> <span class="token class-name">E</span><span class="token punctuation">></span></span><span class="token punctuation">)</span> x<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>不是所有对象都可以强转的。。。。</p>
<p>我们在写 demo 的时候习惯性得使用 <strong>Integer，String</strong> 这些类，这些类都已经实现了 Comparable 接口；</p>
<p><span style="color:red;"><strong>但是如果要比较自定义类，那该类必须实现 Comparable 接口。</strong></span></p>
<p>siftUpUsingComparator 使用优先队列的比较器也是相同原理，就不写了。</p>
<p>。。。。哦，然后再把刚刚插入元素的图解放一哈</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/PriorityQueueSource4.png" alt="PriorityQueueSource4"></p>
<br>
<h4 id="poll" tabindex="-1"><a class="header-anchor" href="#poll" aria-hidden="true">#</a> <span id="t32">poll()</span></h4>
<p>弹出队列头元素，优先队列虽然是单向的，但是已经不是简单的先进先出了。。</p>
<p>在 add 方法中已经介绍，添加时会重新排序，所以弹出时也是按比较排序后结果输出。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//弹出队列头元素</span>
    <span class="token annotation punctuation">@SuppressWarnings</span><span class="token punctuation">(</span><span class="token string">"unchecked"</span><span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
    ...
    <span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">siftDownComparable</span><span class="token punctuation">(</span><span class="token keyword">int</span> k<span class="token punctuation">,</span> <span class="token class-name">E</span> x<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        queue<span class="token punctuation">[</span>k<span class="token punctuation">]</span> <span class="token operator">=</span> key<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>基本逻辑和添加方法是一样的，只是添加方法是将元素从最底层往上移动，弹出方法是将指定元素从最上层往下移动。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/PriorityQueueSource5.png" alt="PriorityQueueSource5"></p>
<br>
<h4 id="grow-扩容" tabindex="-1"><a class="header-anchor" href="#grow-扩容" aria-hidden="true">#</a> <span id="t33">grow() 扩容</span></h4>
<p>然后再看下 add() 方法中出现的扩容方法，数组底层，扩容问题肯定是绕不开的。。。这个涉及到增删的效率。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//如果当前队列元素个数大于等于数组长度</span>
    <span class="token comment">//数组已经填充满了，进行扩容</span>
    <span class="token keyword">if</span> <span class="token punctuation">(</span>i <span class="token operator">>=</span> queue<span class="token punctuation">.</span>length<span class="token punctuation">)</span>
        <span class="token function">grow</span><span class="token punctuation">(</span>i <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>首先可以看到，在 add() 方法中扩容的判断，当数组填充满才会扩容，并且传入参数是长度+1；</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//扩容数组</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>老生常谈的问题了，而且似乎也没啥实际用处：</p>
<ul>
<li>原长度 x 小于64，就扩容为 2x+2</li>
<li>原长度 x 大于等于64，扩容为 1.5倍，扩容一半</li>
<li>最小扩容长度（minCapacity）= 原长度（oldCapacity）+ 1，这是扩容方法调用是传入的参数</li>
<li>若按倍率扩容长度超出最大长度，需要用最小扩容长度进行判断</li>
</ul>
<br>
<h3 id="使用建议" tabindex="-1"><a class="header-anchor" href="#使用建议" aria-hidden="true">#</a> <span id="t4">使用建议</span></h3>
<p>首先看看复杂度：</p>
<ul>
<li>堆排序的平均时间复杂度为O(nlogn),最坏情况也是O(nlogn)，快排的平均时间复杂度也是O(nlogn)，但是最坏情况是O(n²)。</li>
<li>堆排序是O(1)，快排是O(logn)。快排是递归调用，所以空间要求更多一些。</li>
</ul>
<p>使用场景举例：</p>
<ol>
<li>大数据量的筛选：求一亿个数字里面最小的10个数字</li>
<li>业务系统，优先处理 VIP客户 再处理 普通客户，需要自定义比较器。</li>
</ol>
<br>
<h3 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> <span id="te">参考文章</span></h3>
<p><a href="https://www.pdai.tech/md/java/collection/java-collection-PriorityQueue.html" target="_blank">https://www.pdai.tech/md/java/collection/java-collection-PriorityQueue.html</a></p>
<p><a href="https://www.bilibili.com/video/BV1bW411j7jP?t=178" target="_blank">https://www.bilibili.com/video/BV1bW411j7jP?t=178</a></p>
<p><a href="https://www.jianshu.com/p/b1582c3a1296" target="_blank">https://www.jianshu.com/p/b1582c3a1296</a></p>
</div></template>
