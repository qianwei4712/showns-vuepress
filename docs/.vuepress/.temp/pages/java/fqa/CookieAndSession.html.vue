...
<li><a href="#t1">Cookie</a>
<ul>
<li><a href="#t11">Cookie 是个啥</a></li>
<li><a href="#t12">Cookie 的原理</a></li>
<li><a href="#t13">Cookie 源码探索</a></li>
<li><a href="#t14">Cookie 其他细节</a></li>
</ul>
</li>
<li><a href="#t2">Session</a>
<ul>
<li><a href="#t21">什么是 Session</a></li>
<li><a href="#t22">Session 工作机制</a></li>
<li><a href="#t23">HttpSession</a></li>
<li><a href="#t24">其他细节</a></li>
</ul>
</li>
<li><a href="#t3">两者区别</a></li>
<li><a href="#t4">实际场景</a></li>
<li><a href="#t5">参考文章</a></li>
</ul>
</div>
<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> <span id="t0">前言</span></h2>
<p>cookie 和 seesion 这两玩意儿，在三年前刚开始学 java 的时候倒是看到过，不过当时也就看了几眼没有认真学，毕竟我这个基础也算是烂的可以。。。。</p>
<p>这几年光顾着 CRUD，写文档，做实现，基本都已经忘记了。。。</p>
<p>只记得 cookie 在浏览器，seesion 在服务端，平时基本偏向都用 seesion。</p>
<p>最近整理单点登陆时，涉及到了这一部分知识，重新梳理下。。。。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/4AE6Csa1A14FC178154308C99ECCA0CD21.png" alt=""></p>
<br>
<h2 id="cookie" tabindex="-1"><a class="header-anchor" href="#cookie" aria-hidden="true">#</a> <span id="t1">Cookie</span></h2>
<h3 id="cookie-是个啥" tabindex="-1"><a class="header-anchor" href="#cookie-是个啥" aria-hidden="true">#</a> <span id="t11">Cookie 是个啥</span></h3>
<p><strong>cookie 是一种网络会话状态跟踪技术，服务器发送到用户浏览器并保存在本地的一小块数据，它会在浏览器下次向同一服务器再发起请求时被携带并发送到服务器上。</strong></p>
<p>首先，众所周知的，<font color="red"><strong>HTTP 请求是一种无状态协议。</strong></font> 任何两次 HTTP 请求没有任何关系。</p>
<p>然后，会话是由一组请求与响应组成，是围绕着一件事相关事情所进行的请求与响应。</p>
<p>所以在这些请求与响应之间需要有数据传递，用来进行状态跟踪，而 cookie 就是这个技术。</p>
<br>
<h3 id="cookie-的工作原理" tabindex="-1"><a class="header-anchor" href="#cookie-的工作原理" aria-hidden="true">#</a> <span id="t12">Cookie 的工作原理</span></h3>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/20200624091232328.png" alt=""></p>
<p>网上看了些博客和视频，画了下 Cookie 的流程图，然后我们可以从图中看出：</p>
<ol>
<li>Cookie 是在第一次 HTTP 请求时，由服务端生成；</li>
<li>Cookie 也是键值对的形式；</li>
<li>Cookie 通过 HTTP response 返回到客户端，封装在请求头中。</li>
<li>Cookie 是由浏览器进行读取并保存，所以不同浏览器的 Cookie 不互通。</li>
<li>在之后的同路径的请求，才会携带浏览器保存的 Cookie 信息。</li>
</ol>
<p>呃。。。光看些概念类的其实很容易忘，还是看点实际的。</p>
<p>我个人基本用 Chrome，现在写个 demo，测试下 Cookie 在 Chrome 下是如何存在的。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/aHR0cDovL3NoaXZhLm9zcy1jbi1oYW5nemhvdS5hbGl5dW5jcy5jb20vZW1vL1RJTSVFNSU5QiVCRSVFNyU4OSU4NzIwMjAwNjAzMTAwODU4LmpwZw" alt=""></p>
<p>首先，我先写几段服务端代码：</p>
<blockquote>
<p>顺便说明下，我用的测试项目是 SpringBoot，项目名 <code v-pre>server.servlet.context-path=/</code> 直接设置了空；</p>
<p><strong>cookie 的 Path 路径还需要加上项目名，request.getContextPath()</strong> ；</p>
</blockquote>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TestController</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>第一次请求：</strong> <code v-pre>http://localhost:8081/dd</code> 在控制台可以看到：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/20200624091212327.png" alt=""></p>
<p>在 response headers 中添加了 cookie，并设置了 Path；</p>
<p>这里就可以看到，<font color="red"><strong>Cookie 是以明文的方式进行传输和保存的，安全性并不高</strong></font> , 应该是没啥安全性可言。</p>
<p>所以一般只在 Cookie 中保存一些不敏感的信息，和一些加密后的信息。</p>
<br>
<p><strong>同样的方式发起第二次请求：</strong> <code v-pre>http://localhost:8081/dd2</code> ，控制台结果：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/20200624091200496.png" alt="在这里插入图片描述"></p>
<p>可以看到，在请求头中，并没有带 cookie。</p>
<p>再发起一次 <code v-pre>http://localhost:8081/dd</code> 请求：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/20200624091149837.png" alt="在这里插入图片描述"></p>
<p>在浏览器中，也可以对 cookie 进行操作，包括 <strong>禁止</strong> ， <strong>删除</strong> 等。</p>
<p>装个插件也可以直接对 cookie 进行修改，但是并没有实际作用；一般的 cookie 都是加密过的，或者只是个 ID，改了也没啥用。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/20200624091136353.png" alt="在这里插入图片描述"></p>
<p>哦，顺便说下， Chrome 的 Cookies 本地文件位置在：</p>
<blockquote>
<p>C:\Users\XXX\AppData\Local\Google\Chrome\User Data\Default，下面有个 Cookies 文件</p>
</blockquote>
<br>
<h3 id="cookie-源码探索" tabindex="-1"><a class="header-anchor" href="#cookie-源码探索" aria-hidden="true">#</a> <span id="t13">Cookie 源码探索</span></h3>
<p>Cookie 代码很少，去除 getter/setter ,就可怜的不到 100 行；</p>
<p>这里只把参数列一遍，构造方法只有一个带键值对的构造器，没有别的了。。。</p>
<p>会把每个参数涉及到的一些小细节也一并讲了。</p>
...
<h3 id="cookie-其他细节" tabindex="-1"><a class="header-anchor" href="#cookie-其他细节" aria-hidden="true">#</a> <span id="t14">Cookie 其他细节</span></h3>
<p>其他一些细节，很多都是从文档上看到的，看一眼就行，也没啥实际作用：</p>
<ul>
<li>如果没有对 Path 进行设置，默认路径为项目名</li>
<li>浏览器应该支持每台 Web 服务器有 20 个 cookie，总共有 300 个 cookie</li>
<li>每个 cookie 大小不超过 4KB</li>
<li>关闭会话，就是关闭整个浏览器，就可以清楚临时 cookie（ <code v-pre>maxAge = -1</code> ），临时 cookie 保存在浏览器缓存，并没有保存到文件中</li>
<li>一些 cookie 可能有相同的名称，但却有不同的路径属性</li>
<li>对相同名称，切相同路径属性的 cookie，可以进行覆盖</li>
<li>因为 RFC 2109 仍然有点新，所以根据经验可考虑使用版本 1；但在生产网站上不要使用它。</li>
</ul>
<p>And Then。。。。</p>
<p>Cookie 部分就结束了，是不是感觉。。。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/aHR0cDovL3NoaXZhLm9zcy1jbi1oYW5nemhvdS5hbGl5dW5jcy5jb20vZW1vLzIyNVU0MzUzNi05LmpwZw" alt=""></p>
<br>
<h2 id="session" tabindex="-1"><a class="header-anchor" href="#session" aria-hidden="true">#</a> <span id="t2">Session</span></h2>
<h3 id="什么是-session" tabindex="-1"><a class="header-anchor" href="#什么是-session" aria-hidden="true">#</a> <span id="t21">什么是 Session</span></h3>
<p>session 翻译过来就是会议，也就是会话。那么在 HTTP 请求中，会话是什么在上面已经说过了。所以它被设计出来的目的也就很明显了。</p>
<p>session 和 cookie 一样，都是会话跟踪技术。</p>
<p><strong>Session 由服务端创建并保存的会话信息</strong> 。</p>
<p>在 Java 中，session 是以 <code v-pre>javax.servlet.http.HttpSession</code> 接口的形式出现的。</p>
<br>
<h3 id="session-工作机制" tabindex="-1"><a class="header-anchor" href="#session-工作机制" aria-hidden="true">#</a> <span id="t21">Session 工作机制</span></h3>
<p>首先是 Session 的创建，看 <strong>HttpServletRequest</strong> ，太细的就不讲了，介绍个大概。</p>
<table>
<thead>
<tr>
<th style="text-align:center">返回值 - 方法名</th>
<th style="text-align:center">方法解释</th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align:center">HttpSession getSession()</td>
<td style="text-align:center">返回与此请求关联的当前 session，如果没有，则创建一个 session</td>
</tr>
<tr>
<td style="text-align:center">HttpSession getSession( boolean create )</td>
<td style="text-align:center">返回与此请求关联的当前 <code v-pre>HttpSession</code> ，如果没有当前会话并且 <code v-pre>create</code> 为 true，则返回一个新会话。<br>如果 <code v-pre>create</code> 为 <code v-pre>false</code> 并且该请求没有有效的 <code v-pre>HttpSession</code> ，则此方法返回 <code v-pre>null</code> 。<br>要确保会话得到适当维护，必须在提交响应之前调用此方法。如果容器正使用 cookie 维护会话完整性，并被要求在提交响应时创建新会话，则抛出 IllegalStateException。</td>
</tr>
</tbody>
</table>
<p>一般情况下，基本没用过第二个方法获取 session，不过脑补下也是有使用场景的，比如：只需要从 session 获取数据，但是如果不存在 session，不希望主动创建。例如客户端心跳，session 过期后不希望主动创建。</p>
<p>正常情况下，获取 session 的方式如下：</p>
...
<p>Cookie 的机制上面已经介绍了，其实在 session 也需要 cookie 来搭配使用。</p>
...
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/20200624091055442.png" alt="在这里插入图片描述"></p>
<p>从第一次请求可以看出，SpringMVC 返回了一个 cookie 到浏览器。</p>
<p><strong>key 为 JSESSIONID ，并且只允许 http 使用，不允许 javascript 读取。</strong></p>
<p><strong>很明显啊，这个 32 位长度的随机字符串，就是服务端生成的 session 的 ID.</strong></p>
<br>
<p><strong>然后看第二次请求</strong> ：<code v-pre>http://localhost:8081/s2</code> ，请求详情如下：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/20200624090945364.png" alt="在这里插入图片描述"></p>
<p>第二次请求将 session id 带上了。然后服务端就通过这个 session id 获取到 session。</p>
<p><strong>所以，保存在客户端中只是无关紧要的 session id ，真正敏感数据保存在服务端，因此安全性高。</strong></p>
<p>哦还有，<strong>通过这个方式返回的 seesion id 是以临时 Cookie 保存的，没有设置过期时间。</strong> 所以关闭浏览器结束会话，就会清除。</p>
<br>
<h3 id="httpsession-接口方法解析" tabindex="-1"><a class="header-anchor" href="#httpsession-接口方法解析" aria-hidden="true">#</a> <span id="t23">HttpSession 接口方法解析</span></h3>
<p>然后我们来看一下 HttpSession 接口的源码，熟悉下可以对 session 做哪些操作就行：</p>
<p>过时方法就不讲了，应该不重要。。。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">HttpSession</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里再强调下，<font color="red"><strong>Session 的有效间隔默认为 30 分钟</strong></font> 。</p>
<br>
<h3 id="session-其他细节" tabindex="-1"><a class="header-anchor" href="#session-其他细节" aria-hidden="true">#</a> <span id="t24">Session 其他细节</span></h3>
<p>这里就放一些细节问题，也不知道从哪里开始讲，貌似也没啥用，知道下就行：</p>
<ul>
<li>session 因为是保存在服务器上，所以不支持跨域的访问；</li>
<li>sesssion 内保存的键值对的值不能为 null , 或者说可以为 null，但是没有任何意义；</li>
<li>大部分服务端应用在关闭、重新的时候也会使 session 失效，session 原本保存是在内存中的；</li>
<li>Tomcat 默认开启了 session 的钝化，在关闭是会保存到磁盘，重新启动后读取；</li>
<li>因此 session 会占用服务器资源，虽然 session 没有大小限制，但是过大影响性能</li>
</ul>
<br>
<h2 id="cookie-和-session-的对比" tabindex="-1"><a class="header-anchor" href="#cookie-和-session-的对比" aria-hidden="true">#</a> <span id="t3">Cookie 和 Session 的对比</span></h2>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:center">创建和保存</td>
<td style="text-align:center">由服务端创建，通过 http response 返回；<br/>保存在客户端（硬盘或者缓存）</td>
<td style="text-align:center">由服务端创建，保存在服务端容器中(Tomcat 会 session 保存到磁盘，下次启动再读取)；<br/>将 session 的 ID 通过 cookie 返回到客户端。</td>
</tr>
<tr>
<td style="text-align:center">对象形式</td>
<td style="text-align:center">键值对，明文形式；只能保存 ASCII</td>
<td style="text-align:center">以键值对的形式保存，可以保存任意字符</td>
</tr>
<tr>
<td style="text-align:center">大小容量</td>
<td style="text-align:center">浏览器应该支持每台 Web 服务器有 20 个 cookie，总共有 300 个 cookie；<br>每个 cookie 大小不超过 4KB</td>
<td style="text-align:center">没有限制</td>
</tr>
<tr>
<td style="text-align:center">有效时间</td>
<td style="text-align:center">通过 maxAge 设置最大存在时间</td>
<td style="text-align:center">通过 setMaxInactiveInterval 设置两次调用之间的最大时长；超出则失效</td>
</tr>
<tr>
<td style="text-align:center">安全性</td>
<td style="text-align:center">明文传输、明文保存，安全性不高</td>
<td style="text-align:center">保存在服务端，所以不容易泄露</td>
</tr>
<tr>
<td style="text-align:center">性能占用</td>
<td style="text-align:center">将性能压力分发到了客户端浏览器，所以不占用服务端资源</td>
<td style="text-align:center">所有计算和存储都在服务端完成，对服务端会产生较大压力</td>
</tr>
<tr>
<td style="text-align:center"><strong>使用场景</strong></td>
<td style="text-align:center">1. 会话状态管理（如用户登录状态、购物车、游戏分数或其它需要记录的信息）<br/>2. 个性化设置（如用户自定义设置、主题等）<br/>3. 浏览器行为跟踪（如跟踪分析用户行为等）</td>
<td style="text-align:center">用户登陆信息</td>
</tr>
</tbody>
</table>
<br>
<h2 id="实际场景的使用问题" tabindex="-1"><a class="header-anchor" href="#实际场景的使用问题" aria-hidden="true">#</a> <span id="t4">实际场景的使用问题</span></h2>
<h3 id="cookie-被禁用" tabindex="-1"><a class="header-anchor" href="#cookie-被禁用" aria-hidden="true">#</a> Cookie 被禁用</h3>
<p>cookie 保存是浏览器的工作，但是浏览器提供了禁用 cookie 的选项。（还能不能好好合作了。。。）</p>
<p>然后我在网上找了几种方案，也不知道对不对（确实也从没遇到过，而且我以前做的系统居然没有考虑这个）：</p>
<ul>
<li>每次请求都携带一个 session id 的参数，GET、POST 都行；URL 重写，在路径最后加上 session id</li>
<li>Token 机制。和 session 机制相似，但是 token 是通过数据体返回的以后通过 token 来判断身份</li>
</ul>
<h3 id="session-统一问题" tabindex="-1"><a class="header-anchor" href="#session-统一问题" aria-hidden="true">#</a> Session 统一问题</h3>
<p>首先假设有两台相同的 Server，内部代码完全一样，每个 Server 都自己的 session。</p>
<p>可以采用的解决方案：</p>
<ol>
<li><strong>nginx 使用 ip hash 模式</strong> ，根据 ip 会固定分配至一个 server。具体实现可以参考：
<a target="_blank" href="https://blog.csdn.net/m0_46144826/article/details/106844587">https://blog.csdn.net/m0_46144826/article/details/106844587</a></li>
<li>两个服务端之间进行 <strong>Session 同步</strong> ，其实就是将 Session 信息相互拷贝。</li>
<li>引入 <strong>第三方缓存中间件</strong> ，例如 Redis 。</li>
</ol>
<p>这三种方式各有优缺点，使用场景也不一样，一般视情况选用。</p>
<p>但是在分布式架构下，一般都是引入单点登陆，使用一个专门的服务来管理 session。</p>
<p>呼应上了吧。。。本来就是在看单点等时候发现了 seesion 的问题</p>
<br>
<h2 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> <span id="t5">参考文章</span></h2>
<p><a target="_blank" href="https://blog.csdn.net/chengjiamei/article/details/90313274">https://blog.csdn.net/chengjiamei/article/details/90313274</a></p>
<p><a target="_blank" href="https://blog.csdn.net/weixin_37264997/article/details/90693525">https://blog.csdn.net/weixin_37264997/article/details/90693525</a></p>
<p><a target="_blank" href="https://www.bilibili.com/video/BV1s4411z7zq">https://www.bilibili.com/video/BV1s4411z7zq</a></p>
<p><a target="_blank" href="https://blog.csdn.net/chen13333336677/article/details/100939030">https://blog.csdn.net/chen13333336677/article/details/100939030</a></p>
<p><a target="_blank" href="https://www.cnblogs.com/relucent/p/4171478.html">https://www.cnblogs.com/relucent/p/4171478.html</a></p>
<p><a target="_blank" href="https://blog.csdn.net/qq_29062045/article/details/79290142">https://blog.csdn.net/qq_29062045/article/details/79290142</a></p>
<p><a target="_blank" href="https://blog.csdn.net/weixin_46278125/article/details/106634812">https://blog.csdn.net/weixin_46278125/article/details/106634812</a></p>
</div></template>
