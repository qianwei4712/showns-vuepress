...
<ul>
<li><a href="#%E5%BC%80%E5%9C%BA%E5%BA%9F%E8%AF%9D">开场废话</a></li>
<li><a href="#%E5%9F%BA%E7%A1%80%E7%9F%A5%E8%AF%86">Redis 基础知识</a></li>
<li><a href="#%E5%B8%B8%E8%A7%81%E9%85%8D%E7%BD%AE">Redis 常见配置</a></li>
<li><a href="#%E5%BA%94%E7%94%A8%E6%A1%88%E4%BE%8B">Redis 应用案例</a>
<ul>
<li><a href="#%E6%B6%88%E6%81%AF%E9%98%9F%E5%88%97">消息队列</a></li>
<li><a href="#%E8%AE%A1%E6%95%B0%E5%99%A8%E5%BA%94%E7%94%A8">计数器应用</a></li>
<li><a href="#%E6%8E%92%E5%BA%8F%E9%98%9F%E5%88%97">排序队列</a></li>
</ul>
</li>
<li><a href="#%E5%B8%B8%E8%A7%81%E8%A7%A3%E5%86%B3%E6%96%B9%E6%A1%88">常见解决方案</a>
<ul>
<li><a href="#%E6%95%B0%E6%8D%AE%E6%8C%81%E4%B9%85%E5%8C%96">数据持久化</a></li>
<li><a href="#%E5%88%86%E5%B8%83%E5%BC%8F%E9%94%81">基于Redis的分布式锁</a></li>
<li><a href="#%E5%B8%B8%E8%A7%81%E5%91%BD%E4%BB%A4%E6%A3%80%E7%B4%A2%E8%A1%A8">常见命令检索表</a></li>
</ul>
</li>
<li><a href="#te">参考文章</a></li>
</ul>
</div>
<h2 id="开场废话" tabindex="-1"><a class="header-anchor" href="#开场废话" aria-hidden="true">#</a> <span id="开场废话">开场废话</span></h2>
<p><code v-pre>2022.08.12</code></p>
<p>Redis 这个系列学习，我打算通过场景案例来写这一篇，说不定以后会遇到特定场景来找解决方案。</p>
<p>所以这一篇应该不会有什么技术深度。</p>
...
<ul>
<li>Redis 中文翻译网站：<a href="http://redis.cn/" target="_blank" rel="noopener noreferrer">CRUG网站 (redis.cn)<ExternalLinkIcon/></a></li>
<li>测试代码：<a href="https://gitee.com/learning-use-cases/demo4j-of-first/tree/master/redis-unit" target="_blank" rel="noopener noreferrer">redis-unit · Learning Use Cases/Demo4j of First - 码云 - 开源中国 (gitee.com)<ExternalLinkIcon/></a></li>
</ul>
<br/>
<h2 id="redis-基础知识" tabindex="-1"><a class="header-anchor" href="#redis-基础知识" aria-hidden="true">#</a> <span id="基础知识">Redis 基础知识</span></h2>
<h3 id="数据结构" tabindex="-1"><a class="header-anchor" href="#数据结构" aria-hidden="true">#</a> 数据结构</h3>
<p>下面的结构说明，是从翻译站抄过来的：<a href="http://redis.cn/topics/data-types-intro.html#strings" target="_blank" rel="noopener noreferrer">REDIS data-types-intro -- Redis中文资料站 -- Redis中国用户组（CRUG）<ExternalLinkIcon/></a></p>
<ul>
<li>二进制安全的字符串</li>
...
<li>HyperLogLogs: 这是被用于估计一个 set 中元素数量的概率性的数据结构。别害怕，它比看起来的样子要简单…参见本教程的 HyperLogLog 部分</li>
</ul>
<br/>
<h3 id="使用注意" tabindex="-1"><a class="header-anchor" href="#使用注意" aria-hidden="true">#</a> 使用注意</h3>
<ul>
<li>
<p>键值不要太长：不仅因为消耗内存，而且在数据中查找这类键值的计算成本很高</p>
</li>
<li>
<p>为防止在分布式系统中，key被覆盖的情况：</p>
</li>
</ul>
<blockquote>
<p><strong>Key 的设置方式： 业务名+对象名+id+属性</strong></p>
</blockquote>
<br/>
<h3 id="连接工具类" tabindex="-1"><a class="header-anchor" href="#连接工具类" aria-hidden="true">#</a> 连接工具类</h3>
<p>在 Java 中常见的 Redis 连接工具就两种，RedisTemplate 和 jedis；</p>
<ul>
<li>jedis 是 Redis 官方推荐的工具；而 RedisTemplate 是 SpringDataRedis 对 JedisApi 的封装；</li>
<li>原生jedis 效率优于 redisTemplate，速度差不多在3倍；但是 RedisTemplate 在 Spring 中配置简单易用；</li>
<li><strong>性能要求不高的情况下，推荐 RedisTemplate</strong>，现在的小应用都是 SpringBoot 开发，使用方便兼容好。</li>
</ul>
<p>方法对比可以看看这个：<a href="https://www.cnblogs.com/z-sir/p/13664221.html" target="_blank" rel="noopener noreferrer">jedis 与 RedisTemplate 操作比较 - z_先生 - 博客园 (cnblogs.com)<ExternalLinkIcon/></a></p>
<br/>
<h2 id="redis-常见配置" tabindex="-1"><a class="header-anchor" href="#redis-常见配置" aria-hidden="true">#</a> <span id="常见配置">Redis 常见配置</span></h2>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token comment">#是否在后台执行，yes：后台运行；no：不是后台运行</span>
...
<h2 id="redis-应用案例" tabindex="-1"><a class="header-anchor" href="#redis-应用案例" aria-hidden="true">#</a> <span id="应用案例">Redis 应用案例</span></h2>
<h3 id="消息队列" tabindex="-1"><a class="header-anchor" href="#消息队列" aria-hidden="true">#</a> <span id="消息队列">消息队列</span></h3>
<p>学redis之前，确实没想过还能用来做消息队列的。</p>
<p>想了下，感觉还是蛮实用的，在一些不值得上 MQ 的小系统里面，用 Redis 也是个不错的方式。</p>
<ul>
<li>sorted-set 就不写了，没什么特别的优点；</li>
<li>zadd 也能实现延时队列，不过需要轮询监听，没有阻塞式的消费方法，还是算了。</li>
</ul>
<h4 id="list-结构" tabindex="-1"><a class="header-anchor" href="#list-结构" aria-hidden="true">#</a> List 结构</h4>
<p><strong>Redis 的 List 其实是一个双向链表，可以用来实现双向队列；支持多个生产者、多个消费者</strong></p>
<blockquote>
<p><span style="color:red"><strong>基于 LPUSH（左侧入队） + RPOP（右侧出队）实现；将出队轮询，进一步优化使用 BRPOP（阻塞式获取消息）优化</strong></span></p>
</blockquote>
<p><strong>方案缺点：</strong></p>
<ul>
<li>无法避免消息丢失：例如消费者拿到消息还没有消费就宕机了，ACK 实现比较麻烦</li>
<li>只能支持单个消费、不支持广播</li>
<li>BRPOP 在阻塞过程中会占用连接，长时间没有消息，redis 会断开连接节省资源，没有重连的话就功能失效了</li>
</ul>
<hr>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//左侧消息入队</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的出队列是最基础的出队，还需要考虑两个问题：</p>
<ul>
<li><strong>最长阻塞时间为5分钟，到达时间或者获取到消息，就会立刻结束监听</strong></li>
<li><strong>所以在redis关闭连接、或者消息返回后，要重新开启监听</strong></li>
</ul>
<p>所以可以定义一个队列消费者：</p>
...
<p>常见模型，不多讲了。<strong>消费者可以订阅一个或者多个channel、一个消息可以发布到多个消费者、消息即时发送，消息不用等待消费者读取</strong></p>
<p>适合用在消息送达要求不高的场景、例如通知公告、群聊。</p>
<p><strong>方案缺点：</strong></p>
<ul>
<li>消息一旦发布，不能接收。换句话就是发布时若客户端不在线，则消息丢失，不能寻回</li>
<li>消费端若出现阻塞积压，会强制断开连接，导致消息丢失。</li>
</ul>
<hr>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Slf4j</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MessageSubHandler</span> <span class="token keyword">implements</span> <span class="token class-name">MessageListener</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后测试类只需要发送就好了。。。</p>
<br/>
<h4 id="stream" tabindex="-1"><a class="header-anchor" href="#stream" aria-hidden="true">#</a> stream</h4>
<p>Stream是支持多播、可持久化、主从复制的消息队列。</p>
<p>Redis Stream 有一个消息链表，将所有加入的消息都串起来，每个消息都有一个唯一的 ID 和对应的内容。每个 Stream 都有唯一的名称，它就是 Redis 的 key；</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/format,png.png" alt=""></p>
<p>参考下图，带上持久化 和 ACK，该有的都有了。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/8c6ded5f367a429c8455d8b1a9b3d94a.png" alt=""></p>
<p>这个方案没有什么缺点，毕竟是参考 kafka 专门设计。。</p>
<hr>
<p>代码实现：</p>
<p>自动创建 stream 分组：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Slf4j</span>
...
<h3 id="计数器应用" tabindex="-1"><a class="header-anchor" href="#计数器应用" aria-hidden="true">#</a> <span id="计数器应用">计数器应用</span></h3>
<p>计数器应用可能不太广泛，重要的计数肯定是在数据库里的，比如：预售数量、订餐数量。</p>
<p>不是特别重要的技术才可能在redis内，例如：人流量、点击量。</p>
<p>具体可以看看别的大佬：<a href="https://www.gxlcms.com/mysql-317790.html" target="_blank" rel="noopener noreferrer">Redis在计数器场景上的应用 (gxlcms.com)<ExternalLinkIcon/></a></p>
<p>代码实现：</p>
...
<h3 id="排序队列" tabindex="-1"><a class="header-anchor" href="#排序队列" aria-hidden="true">#</a> <span id="排序队列">排序队列</span></h3>
<p>也没什么特别的，知道有这么个玩意儿，有需要自己扩展就好了：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/image-20220817225407728.png" alt=""></p>
<br/>
<h2 id="常见解决方案" tabindex="-1"><a class="header-anchor" href="#常见解决方案" aria-hidden="true">#</a> <span id="常见解决方案">常见解决方案</span></h2>
<h3 id="数据持久化" tabindex="-1"><a class="header-anchor" href="#数据持久化" aria-hidden="true">#</a> <span id="数据持久化">数据持久化</span></h3>
<p>这部分直接看大佬们：</p>
<ul>
<li><a href="https://www.cnblogs.com/ciel717/p/16466230.html" target="_blank" rel="noopener noreferrer">Redis持久化 - 夏尔_717 - 博客园 (cnblogs.com)<ExternalLinkIcon/></a></li>
<li><a href="https://www.bilibili.com/video/BV1sV4y147Jz/?spm_id_from=333.788&amp;vd_source=e768d8ae5d35e9620400ecb1e8983682" target="_blank" rel="noopener noreferrer">【趣话Redis第二弹】Redis数据持久化AOF和RDB原理一次搞懂！_哔哩哔哩_bilibili<ExternalLinkIcon/></a></li>
<li><a href="https://www.bilibili.com/video/BV1U34y1j7Gr?vd_source=e768d8ae5d35e9620400ecb1e8983682" target="_blank" rel="noopener noreferrer">讲一下redis持久化方案(RDB,AOF,混合)_哔哩哔哩_bilibili<ExternalLinkIcon/></a></li>
</ul>
<hr>
<p><strong>RDB 方式：</strong></p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/4ee3203524c53279a9d9855ea6b797c6-16608311291795.png" alt=""></p>
<p><strong>AOF 方式：</strong></p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/a2bd9ae133cad87898c6494410ecd9f0.png" alt=""></p>
<p>我就总结一些自己用的配置和命令，使用 <code v-pre>RDB(Redis DataBase) 内存快照</code>、<code v-pre>AOF(Append Only File) 增量日志</code> 的混合模式：</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token comment"># 核心配置规则、可以混合使用</span>
<span class="token comment"># 300秒（5分钟）内至少10个key值改变（则进行数据库保存--持久化） </span>
<span class="token comment"># 60秒（1分钟）内至少10000个key值改变（则进行数据库保存--持久化）</span>
<span class="token key attr-name">save</span> <span class="token value attr-value">300 10</span>
<span class="token key attr-name">save</span> <span class="token value attr-value">60 10000</span>
...
<p><strong>正常情况下，只开启 RDM 就够用了；</strong></p>
</blockquote>
<br/>
<h3 id="基于redis的分布式锁" tabindex="-1"><a class="header-anchor" href="#基于redis的分布式锁" aria-hidden="true">#</a> <span id="分布式锁">基于Redis的分布式锁</span></h3>
<p>这里写两种方案：</p>
<ul>
<li><strong>基于 setnx 实现</strong>：实现简单，全手写，不引入其他依赖；但是在存在缺陷</li>
<li><strong>基于 redisson 实现</strong>：成熟框架，该有的都有，完美工具</li>
</ul>
<h4 id="基于-setnx-实现" tabindex="-1"><a class="header-anchor" href="#基于-setnx-实现" aria-hidden="true">#</a> 基于 setnx 实现</h4>
<p>这个方案在思路上相对简单, 只需要一个redis就可以实现。总体架构如下:</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/image-20220819232911917.png" alt=""></p>
<p>代码的实现逻辑如下:</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/image-20220820140420432.png" alt=""></p>
<p><strong>获得锁的线程在执行过程中出现异常（服务宕机、阻塞、抛出异常），那么没用调用删除锁命令，会导致其他永远线程无法获得锁。</strong></p>
<blockquote>
<p>给这个 redis 锁加一个过期时间，确保其他服务线程正常使用</p>
</blockquote>
<p><strong>setnx 和 expire 是两个命令，不是原子操作；可能导致 setnx 还没设置过期就挂掉</strong></p>
<blockquote>
<p>spring中用 <code v-pre>setIfAbsent(key, value, timeout, timeUnit)</code> ，这个方法是原子性的；</p>
<p>底层用的是 <code v-pre>set key value [EX seconds] [PX milliseconds] [NX|XX]</code></p>
</blockquote>
<p><strong>如果线程A获得锁，设置锁过期30秒，但是在30内还没执行完；这个时候B线程获得了新锁，35秒时候A线程执行完毕，把B线程的锁删了，引发连锁反应</strong></p>
<blockquote>
<p>所以在删除 key 之前，需要先 <code v-pre>get + 判断是不是同一把锁 + del</code> 操作;</p>
<p>但是这系列操作不是原子操作，无法在 java 中完成；网上说可以通过 LUA 脚本完成</p>
</blockquote>
<hr>
<p>代码实现，以下是基于我对这个方案的理解，<strong>手写的，没用测试过，只是个小demo</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Slf4j</span>
...
<h4 id="基于-redisson-实现" tabindex="-1"><a class="header-anchor" href="#基于-redisson-实现" aria-hidden="true">#</a> 基于 redisson 实现</h4>
<p><strong>redisson 自带 锁续期、看门狗、单体/集群/主从/哨兵等redis架构的适配</strong>，反正就是你想要的这里全都有。</p>
<p>这里要稍微介绍下的应该就是这个 看门狗机制：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/202204/image-20220820213426578.png" alt=""></p>
<p><strong>watch dog 的自动延期机制：</strong></p>
<blockquote>
<ul>
<li>redisson 在获取锁之后，会维护一个看门狗线程，在每一个锁设置的过期时间的1/3处，如果线程还没执行完任务，则不断延长锁的有效期。看门狗的检查锁超时时间默认是30秒，可以通过 lockWactchdogTimeout 参数来改变。</li>
<li>加锁的时间默认是30秒，如果加锁的业务没有执行完，那么每隔 30 ÷ 3 = 10秒，就会进行一次续期，把锁重置成30秒，保证解锁前锁不会自动失效。</li>
<li>如果系统宕机、或者异常，那么作为子线程的看门狗也会中断，那么等待30秒就锁到期。</li>
<li><strong>这里要注意，绝对不能在这个业务执行中进入死循环，不然永久续期了都。</strong></li>
</ul>
</blockquote>
<p><strong>redisson分布式锁的关键点：</strong></p>
<blockquote>
<ul>
<li>对key不设置过期时间，由Redisson在加锁成功后给维护一个watchdog看门狗，watchdog负责定时监听并处理，在锁没有被释放且快要过期的时候自动对锁进行续期，保证解锁前锁不会自动失效</li>
<li>通过Lua脚本实现了加锁和解锁的原子操作</li>
<li>通过记录获取锁的客户端id，每次加锁时判断是否是当前客户端已经获得锁，实现了可重入锁。</li>
</ul>
</blockquote>
<p><strong>如何开启看门狗：</strong></p>
<blockquote>
<p>只要获得锁的时候，别给锁加过期时间，就自动开启</p>
</blockquote>
<hr>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Slf4j</span>
...
<p>集群、哨兵遇到了再搞吧，也不复杂：</p>
<br/>
<h3 id="常见命令检索表" tabindex="-1"><a class="header-anchor" href="#常见命令检索表" aria-hidden="true">#</a> <span id="常见命令检索表">常见命令检索表</span></h3>
<p>这些都是终端敲的，一般用不到太多，基本都是在代码里用，所以只写一些用得上的</p>
<table>
<thead>
<tr>
<th>命令 + 作用</th>
...
<tbody>
<tr>
<td>exists key；键是否存在</td>
<td>set key value；设置键值</td>
<td>del key；删除键值</td>
<td>expire key seconds；设置过期时间</td>
<td>ttl key；获得过期时间</td>
<td>type key；返回key的类型</td>
</tr>
<tr>
<td>rename oldkey newkey；重命名</td>
<td>getset key newValue；原子操作，设置新值，返回旧值</td>
<td>setnx key value；key不存在则设置</td>
<td></td>
<td></td>
<td></td>
</tr>
...
<ul>
<li><a href="https://www.bilibili.com/video/BV1Tf4y177L5?spm_id_from=333.999.0.0&amp;vd_source=e768d8ae5d35e9620400ecb1e8983682" target="_blank" rel="noopener noreferrer">【全套免费】GitHub 上标星60K 的Redis入门到精通全套教程，从GitHub火到了B站！让你彻底告别资源付费！！！_哔哩哔哩_bilibili<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/qq_59138417/article/details/124525767" target="_blank" rel="noopener noreferrer">使用Java操作Redis的两种方式Jedis、RedisTemplate_扎哇太枣糕的博客-CSDN博客_java操作redis有几种方法<ExternalLinkIcon/></a></li>
<li><a href="http://www.muzhuangnet.com/show/47024.html" target="_blank" rel="noopener noreferrer">jedis和redistemplate区别-木庄网络博客 (muzhuangnet.com)<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/weixin_45690465/article/details/124566098" target="_blank" rel="noopener noreferrer">Redis实现消息队列_..Serendipity的博客-CSDN博客_redis消息队列<ExternalLinkIcon/></a></li>
<li><a href="https://www.jianshu.com/p/d32b16f12f09" target="_blank" rel="noopener noreferrer">Redis实现消息队列的4种方案 - 简书 (jianshu.com)<ExternalLinkIcon/></a></li>
<li><a href="https://www.cnblogs.com/yaohl0911/p/14932134.html" target="_blank" rel="noopener noreferrer">【转载】Redis实现消息队列的4种方案 - yaohl0911 - 博客园 (cnblogs.com)<ExternalLinkIcon/></a></li>
<li><a href="https://www.jb51.net/article/230977.htm" target="_blank" rel="noopener noreferrer">Java redisTemplate阻塞式处理消息队列_java_脚本之家 (jb51.net)<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/z2431435/article/details/124978166" target="_blank" rel="noopener noreferrer">Redis消息队列——Redis Stream_努 力 小 子的博客-CSDN博客_redis stream<ExternalLinkIcon/></a></li>
<li><a href="https://zhuanlan.zhihu.com/p/440831491" target="_blank" rel="noopener noreferrer">Java spring boot redisTemplate之Stream组件 - 知乎 (zhihu.com)<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/hhl18730252820/article/details/114826366" target="_blank" rel="noopener noreferrer">SpringBoot 中使用Redis Stream 实现消息监听_@胡海龙的博客-CSDN博客_redis消息监听器容器<ExternalLinkIcon/></a></li>
<li><a href="https://stackoverflow.com/questions/61465222/how-to-use-consumer-groups-with-spring-data-redis-for-redis-streams-keep-gettin" target="_blank" rel="noopener noreferrer">java - 如何将消费者组与Spring Data Redis for Redis Streams一起使用（继续获得NOGROUP）？- 堆栈溢出 (stackoverflow.com)<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/nianqrzhanghw/article/details/121163780" target="_blank" rel="noopener noreferrer">Redis持久化_hi wei的博客-CSDN博客_redis持久化<ExternalLinkIcon/></a></li>
<li><a href="https://www.cnblogs.com/ciel717/p/16466230.html" target="_blank" rel="noopener noreferrer">Redis持久化 - 夏尔_717 - 博客园 (cnblogs.com)<ExternalLinkIcon/></a></li>
<li><a href="http://www.wjhsh.net/chuijingjing-p-12832678.html" target="_blank" rel="noopener noreferrer">Redis配置文件详解 (wjhsh.net)<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/x275920/article/details/125409441" target="_blank" rel="noopener noreferrer">什么是分布式锁？几种分布式锁分别是怎么实现的？_普通网友的博客-CSDN博客_分布式锁- <ExternalLinkIcon/></a></li>
<li><a href="https://www.cnblogs.com/goloving/p/16026003.html" target="_blank" rel="noopener noreferrer">浅析redis setIfAbsent的用法及在分布式锁上的应用及同步锁的缺陷 - 古兰精 - 博客园 (cnblogs.com)<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/qq_35429398/article/details/121629496" target="_blank" rel="noopener noreferrer">SpringBoot集成redisson_克伦留索夫的博客-CSDN博客_springboot集成redisson<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/m0_45364328/article/details/125175796" target="_blank" rel="noopener noreferrer">Redisson的看门狗机制_JAVA_侠的博客-CSDN博客_redisson看门狗机制<ExternalLinkIcon/></a></li>
</ul>
</div></template>
