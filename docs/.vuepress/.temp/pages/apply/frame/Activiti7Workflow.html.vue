...
<li><a href="#BPMN">BPMN 流程定义</a></li>
<li><a href="#demo">Activiti7 基础Demo</a></li>
<li><a href="#api">Activiti 常用API</a></li>
<li><a href="#%E5%85%B7%E4%BD%93%E4%B8%9A%E5%8A%A1%E5%9C%BA%E6%99%AF%E5%AE%9E%E7%8E%B0">具体业务场景实现</a>
<ul>
<li><a href="#%E7%8E%AF%E5%A2%83%E5%87%86%E5%A4%87">环境准备</a></li>
<li><a href="#%E5%91%98%E5%B7%A5%E8%AF%B7%E5%81%87%E5%AE%A1%E6%89%B9">员工请假审批</a></li>
<li><a href="#%E5%91%98%E5%B7%A5%E7%A6%BB%E8%81%8C%E5%AE%A1%E6%89%B9">员工离职审批</a></li>
<li><a href="#%E8%B4%B9%E7%94%A8%E6%8A%A5%E9%94%80%E5%A4%9A%E4%BA%BA%E4%BC%9A%E7%AD%BE">费用报销多人会签</a></li>
<li><a href="#%E5%85%AC%E5%8F%B8%E7%BC%BA%E4%BA%BA%E7%A6%BB%E8%81%8C%E4%B8%8D%E6%89%B9">公司缺人离职不批</a></li>
<li><a href="#%E6%B5%81%E7%A8%8B%E7%AD%BE%E7%BD%B2%E8%87%AA%E5%8A%A8%E6%8F%90%E9%86%92">流程签署自动提醒</a></li>
</ul>
</li>
...
<p><code v-pre>2022.02.25</code></p>
<p>工作流引擎算是个很好的工具，不过 activiti 组织变动后，不怎么给力了，更新也不积极了。</p>
<p>新的 flowable 听说还不错，不过因为目前项目用了activiti ，先试试水。</p>
<ul>
<li>官网文档：<a href="https://www.activiti.org/documentation" target="_blank" rel="noopener noreferrer">Documentation | Activiti<ExternalLinkIcon/></a></li>
<li>API文档：<a href="https://www.activiti.org/javadocs/" target="_blank" rel="noopener noreferrer">Overview (Activiti - Engine 5.22.0 API)<ExternalLinkIcon/></a></li>
<li>Github 地址：<a href="https://github.com/Activiti/Activiti" target="_blank" rel="noopener noreferrer">Activiti/Activiti<ExternalLinkIcon/></a></li>
</ul>
<p>工作流作用就不比比了，直接进入正题。总体的使用流程如下：</p>
<ol>
<li>使用 BPMN 建模工具，绘制业务流程图，它的本质是一个规范的 XML 文件</li>
<li>将业务流程图，导入到工作流引擎中，也就是存到数据库里</li>
<li>在业务系统中调用工作流引擎提供的接口</li>
</ol>
<p>把代码放上：</p>
<ul>
<li>绘图工具仓库地址：<a href="https://gitee.com/learning-use-cases/springboot-activiti7-modeler" target="_blank" rel="noopener noreferrer">Learning Use Cases/springboot-activiti7-modeler (gitee.com)<ExternalLinkIcon/></a></li>
<li>hello world仓库地址：<a href="https://gitee.com/learning-use-cases/activiti-first" target="_blank" rel="noopener noreferrer">Learning Use Cases/activiti-first (gitee.com)<ExternalLinkIcon/></a></li>
<li>完整业务流程案例：<a href="https://gitee.com/qianwei4712/code-of-shiva/tree/master/activiti" target="_blank" rel="noopener noreferrer">code of shiva - Gitee.com<ExternalLinkIcon/></a></li>
</ul>
<br>
<h2 id="bpmn-流程定义" tabindex="-1"><a class="header-anchor" href="#bpmn-流程定义" aria-hidden="true">#</a> <span id="BPMN">BPMN 流程定义</span></h2>
<p>首先，应该都见过工作流的流程图：</p>
<blockquote>
<p>BPMN（Business Process Model AndNotation）- 业务流程模型和符号，是一套标准的业务流程建模符号，使用BPMN提供的符号可以创建业务流程。</p>
</blockquote>
<p>网上有很多在线绘制网站，例如：</p>
<ul>
<li><a href="https://bpmn.52itstyle.vip/" target="_blank" rel="noopener noreferrer">BPMN在线作图工具 (52itstyle.vip)<ExternalLinkIcon/></a></li>
<li><a href="https://www.freedgo.com/" target="_blank" rel="noopener noreferrer">在线免费绘图工具 | 裕奥在线绘图工具Freedgo<ExternalLinkIcon/></a></li>
</ul>
<h3 id="bpmn-图形释义" tabindex="-1"><a class="header-anchor" href="#bpmn-图形释义" aria-hidden="true">#</a> BPMN 图形释义</h3>
<p><strong>事件（Event）</strong></p>
<p><strong>用一个圆圈表示</strong>，它是流程中运行过程中发生的事情。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/20201106094336416.png" alt="20201106094336416"></p>
<p><strong>活动（Activity）</strong></p>
<p><strong>活动用圆角矩形表示</strong>，一个流程由一个活动或多个活动组成</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/clip_image002-1573894978125.jpg" alt="clip_image002-1573894978125"></p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/22111574562726375.png" alt="22111574562726375"></p>
<p><strong>网关 GateWay</strong></p>
<p>网关用来处理决策，有几种常用网关需要了解：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/1574563600305.png" alt=""></p>
<p>排他网关 (x)</p>
<p>——只有一条路径会被选择。流程执行到该网关时，按照输出流的顺序逐个计算，当条件的计算结果为true时，继续执行当前网关的输出流；</p>
<pre><code>如果多条线路计算结果都是 true，则会执行第一个值为 true 的线路。如果所有网关计算结果没有true，则引擎会抛出异常。
排他网关需要和条件顺序流结合使用，default 属性指定默认顺序流，当所有的条件不满足时会执行默认顺序流。
</code></pre>
<p>并行网关 (+)</p>
<p>——所有路径会被同时选择</p>
<pre><code>拆分 —— 并行执行所有输出顺序流，为每一条顺序流创建一个并行执行线路。
合并 —— 所有从并行网关拆分并执行完成的线路均在此等候，直到所有的线路都执行完成才继续向下执行。
</code></pre>
<p>包容网关 (+)</p>
<p>—— 可以同时执行多条线路，也可以在网关上设置条件</p>
<pre><code>拆分 —— 计算每条线路上的表达式，当表达式计算结果为true时，创建一个并行线路并继续执行
合并 —— 所有从并行网关拆分并执行完成的线路均在此等候，直到所有的线路都执行完成才继续向下执行。
</code></pre>
<p>事件网关 (+)</p>
...
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/1574563937457.png" alt=""></p>
<h3 id="bpmn-本质" tabindex="-1"><a class="header-anchor" href="#bpmn-本质" aria-hidden="true">#</a> BPMN 本质</h3>
<p>在 <a href="https://bpmn.52itstyle.vip/" target="_blank" rel="noopener noreferrer">BPMN在线作图工具 (52itstyle.vip)<ExternalLinkIcon/></a> 随便画了个图：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220225205812315.png" alt="image-20220225205812315"></p>
<p>下载后为 BPMN 文件后，文本模式打开，它的实际内容为一个 XML：</p>
...
<br>
<h2 id="activiti7-基础demo" tabindex="-1"><a class="header-anchor" href="#activiti7-基础demo" aria-hidden="true">#</a> <span id="demo">Activiti7 基础Demo</span></h2>
<p>代码第一步，整一个 hello world 出来。</p>
<p>这里涉及到两个工程，连一个数据库。</p>
<h3 id="环境准备" tabindex="-1"><a class="header-anchor" href="#环境准备" aria-hidden="true">#</a> 环境准备</h3>
<blockquote>
<p><strong>Demo 环境：JDK8 、SpringBoot 2.6.4 、mysql 、activiti 7</strong></p>
</blockquote>
<p>添加POM依赖：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>application 添加 activiti 配置：</p>
...
<h3 id="bpmn-导入" tabindex="-1"><a class="header-anchor" href="#bpmn-导入" aria-hidden="true">#</a> BPMN 导入</h3>
<p>这里加点新东西，<strong>activiti modeler 设计器，这是一个可以集成在项目里，绘制部署全套流程的界面化工具</strong>。</p>
<p>一步一步来，这里先使用独立版，到后面再整合：</p>
<ul>
<li>绘图工具仓库地址：<a href="https://gitee.com/learning-use-cases/springboot-activiti7-modeler" target="_blank" rel="noopener noreferrer">Learning Use Cases/springboot-activiti7-modeler (gitee.com)<ExternalLinkIcon/></a></li>
<li>测试Demo仓库地址：<a href="https://gitee.com/learning-use-cases/activiti-first" target="_blank" rel="noopener noreferrer">Learning Use Cases/activiti-first (gitee.com)<ExternalLinkIcon/></a></li>
</ul>
<p>这个小 Demo 有部署接口文档，设计器图形界面两部分，详细自己看 readme。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220302113612122.png" alt=""></p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220302174903889.png" alt=""></p>
<p>在设计器中绘制了一个简单流程，然后保存后自动解析存入数据库</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220302154431883.png" alt=""></p>
<p>顺便指定审批人</p>
<img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220302173319777.png" style="zoom:80%;" />
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220302154533325.png" alt=""></p>
<p>顺便调用一下手动部署的接口</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220302161053179.png" alt=""></p>
<br>
<h3 id="单元测试" tabindex="-1"><a class="header-anchor" href="#单元测试" aria-hidden="true">#</a> 单元测试</h3>
<p>测试主要流程如下：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220302234513397.png" alt=""></p>
<p>模型部署已经在上一步完成，这里直接查询流程定义并启动，然后进行任务审批。</p>
...
<span class="token keyword">class</span> <span class="token class-name">ActivitiFirstApplicationTests</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220302202033846.png" alt=""></p>
<br>
<h3 id="activiti-表结构" tabindex="-1"><a class="header-anchor" href="#activiti-表结构" aria-hidden="true">#</a> Activiti 表结构</h3>
<p>上面的配置中写了自动建表，可以在数据库里看到相应的表和记录。</p>
<p>看到刚才创建的表，我们发现Activiti 的表都以 <code v-pre>ACT_</code> 开头。 第二部分是表示表的用途的两个字母标识。 用途也和服务的 API 对应。</p>
<ul>
<li><strong>ACT_RE</strong> ：'RE' 表示 repository。 这个前缀的表包含了流程定义和流程静态资源 （图片，规则，等等）。</li>
<li><strong>ACT_RU</strong> ：'RU' 表示 runtime。 这些运行时的表，包含流程实例，任务，变量，异步任务，等运行中的数据。 Activiti 只在流程实例执行过程中保存这些数据， 在流程结束时就会删除这些记录。 这样运行时表可以一直很小速度很快。</li>
...
<td>通用的流程定义和流程资源，xml文件详细信息在这里</td>
</tr>
<tr>
<td></td>
...
<td>已部署的流程定义，部署每个新的流程定义都会在这张表中增加一条记录</td>
</tr>
<tr>
<td>运行实例表</td>
<td></td>
...
<td>运行时流程执行实例，记录当前流程实例的执行情况</td>
</tr>
<tr>
<td></td>
<td>[ACT_RU_IDENTITYLINK]</td>
<td>运行时用户关系信息，存储任务节点与参与者的相关信息，记录当前参与任务的用户或组</td>
</tr>
<tr>
<td></td>
<td>[ACT_RU_JOB]</td>
...
<br>
<h2 id="activiti-常用api" tabindex="-1"><a class="header-anchor" href="#activiti-常用api" aria-hidden="true">#</a> <span id="api">Activiti 常用API</span></h2>
<p>这也是个老图了，和新版有点区别，不过无所谓了。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/clip_image002.jpg" alt="clip_image002"></p>
<p>总体来说，API 分为 <strong>引擎</strong> 和 <strong>服务</strong> 两部分。</p>
<p>一般项目中，通常是通过引擎拿到服务，不过对现在都是 spring 整合后的，processEngine 对象来负责创建 Service 对象，直接注入使用。</p>
<h3 id="引擎创建" tabindex="-1"><a class="header-anchor" href="#引擎创建" aria-hidden="true">#</a> 引擎创建</h3>
<p>在一般项目中，我们都是用配置文件读取：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//直接使用工具类 ProcessEngines，使用classpath下的activiti.cfg.xml中的配置创建processEngine</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//先构建ProcessEngineConfiguration</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>不过对 SpringBoot 整合后来说，直接注入就行。</strong></p>
<h3 id="服务调用" tabindex="-1"><a class="header-anchor" href="#服务调用" aria-hidden="true">#</a> 服务调用</h3>
<p>Activiti 核心服务类，就下面几个：</p>
<table>
<thead>
<tr>
<th>service名称</th>
...
<td><strong>是activiti的资源管理类，提供了管理和控制流程发布包和流程定义的操作。使用工作流建模工具设计的业务流程图需要使用此service将流程定义文件的内容部署到计算机。</strong></td>
</tr>
<tr>
<td>RuntimeService</td>
<td>Activiti的流程运行管理类。可以从这个服务类中获取很多关于流程执行相关的信息</td>
</tr>
<tr>
<td>TaskService</td>
<td>Activiti的任务管理类。可以从这个类中获取任务的信息。</td>
</tr>
<tr>
<td>HistoryService</td>
<td>Activiti的历史管理类，可以查询历史信息，执行流程时，引擎会保存很多数据（根据配置）。比如流程实例启动时间，任务的参与者， 完成任务的时间，每个流程实例的执行路径，等等</td>
</tr>
<tr>
<td>ManagerService</td>
<td>Activiti的引擎管理类，提供了对 Activiti 流程引擎的管理和维护功能，这些功能不在工作流驱动的应用程序中使用，主要用于 Activiti 系统的日常维护。</td>
</tr>
</tbody>
</table>
<h4 id="启动流程" tabindex="-1"><a class="header-anchor" href="#启动流程" aria-hidden="true">#</a> 启动流程</h4>
<p><strong>根据已经部署的流程定义，创建一个工作流任务</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 根据流程定义Id启动流程</span>
...
<span class="token class-name">ProcessInstance</span> pi <span class="token operator">=</span> processRuntime<span class="token punctuation">.</span><span class="token function">start</span><span class="token punctuation">(</span><span class="token class-name">ProcessPayloadBuilder</span><span class="token punctuation">.</span>
                                          ...
                                          <span class="token function">withProcessDefinitionKey</span><span class="token punctuation">(</span><span class="token string">"hello_activiti"</span><span class="token punctuation">)</span><span class="token punctuation">.</span>
                                          <span class="token function">build</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="任务查询" tabindex="-1"><a class="header-anchor" href="#任务查询" aria-hidden="true">#</a> 任务查询</h4>
<p><strong>根据当前用户，查询未处理任务列表</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 根据流程key 和 任务负责人 查询任务</span>
...
securityUtil<span class="token punctuation">.</span><span class="token function">logInAs</span><span class="token punctuation">(</span><span class="token string">"jack"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token class-name">Page</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">Task</span><span class="token punctuation">></span></span> taskPage <span class="token operator">=</span> taskRuntime<span class="token punctuation">.</span><span class="token function">tasks</span><span class="token punctuation">(</span><span class="token class-name">Pageable</span><span class="token punctuation">.</span><span class="token function">of</span><span class="token punctuation">(</span><span class="token number">0</span><span class="token punctuation">,</span> <span class="token number">10</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="任务处理" tabindex="-1"><a class="header-anchor" href="#任务处理" aria-hidden="true">#</a> 任务处理</h4>
<p><strong>处理指定任务</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 完成任务,参数：任务id，varibles增量更新变量</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="历史审批查询" tabindex="-1"><a class="header-anchor" href="#历史审批查询" aria-hidden="true">#</a> 历史审批查询</h4>
<p><strong>查询已经完成审批的历史记录</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 获取引擎</span>
<span class="token class-name">ProcessEngine</span> processEngine <span class="token operator">=</span> <span class="token class-name">ProcessEngines</span><span class="token punctuation">.</span><span class="token function">getDefaultProcessEngine</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="流程定义查询" tabindex="-1"><a class="header-anchor" href="#流程定义查询" aria-hidden="true">#</a> 流程定义查询</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// repositoryService</span>
...
<span class="token class-name">List</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">ProcessDefinition</span><span class="token punctuation">></span></span> definitionList <span class="token operator">=</span> processDefinitionQuery<span class="token punctuation">.</span><span class="token function">processDefinitionKey</span><span class="token punctuation">(</span><span class="token string">"myEvection"</span><span class="token punctuation">)</span>
    ...
    <span class="token punctuation">.</span><span class="token function">list</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="流程删除" tabindex="-1"><a class="header-anchor" href="#流程删除" aria-hidden="true">#</a> 流程删除</h4>
<p><strong>删除定义的审批流程</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 流程部署id</span>
...
<ol>
<li>使用repositoryService删除流程定义，历史表信息不会被删除</li>
<li>如果该流程定义下没有正在运行的流程，则可以用普通删除。</li>
<li>如果该流程定义下存在已经运行的流程，使用普通删除报错，可用级联删除方法将流程及相关记录全部删除。
<ol>
<li>先删除没有完成流程节点，最后就可以完全删除流程定义信息</li>
<li>项目开发中级联删除操作一般只开放给超级管理员使用.</li>
</ol>
</li>
</ol>
</blockquote>
<br>
<h2 id="具体业务场景实现" tabindex="-1"><a class="header-anchor" href="#具体业务场景实现" aria-hidden="true">#</a> <span id="具体业务场景实现">具体业务场景实现</span></h2>
<p>工作流的基础使用方式，现在开始要和企业业务进行关联。</p>
<ul>
<li>代码仓库：<a href="https://gitee.com/qianwei4712/code-of-shiva/tree/master/activiti" target="_blank" rel="noopener noreferrer">code of shiva - Gitee.com<ExternalLinkIcon/></a></li>
</ul>
<p>首先要理解：</p>
<blockquote>
<ol>
<li><strong>Activiti 引擎只能操作它自己的相关表</strong></li>
<li><strong>工作流相关表，只存储流程相关信息，不存储任何业务信息，例如：业务单号、业务发生时间、业务审批通过后的后续操作等</strong></li>
</ol>
</blockquote>
<p>所以在业务系统中嵌入工作流，要配合业务表。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220312131549059.png" alt=""></p>
<p>当然了，这种关联关系，工作流肯定已经给我们预留好了：</p>
<p>在 <strong>表ACT_RU_EXECUTION 运行时流程执行实例</strong> 里，有一个 <strong>BUSINESS_KEY_</strong> 字段，可以用来存放关联业务信息字段。</p>
<p>现在来模拟实现以下几个场景：</p>
<ol>
<li>员工请假审批（通配、完成任务）</li>
<li>员工离职审批（拒绝申请、审批回调）</li>
<li>费用报销多人会签（多人同时审批）</li>
<li>公司缺人离职不批（流程挂起）</li>
<li>流程签署自动提醒（监听器）</li>
</ol>
<br>
<h3 id="环境准备-1" tabindex="-1"><a class="header-anchor" href="#环境准备-1" aria-hidden="true">#</a> <span id="环境准备">环境准备</span></h3>
<p>先做下准备工作，表就不建太多了。。。什么请假表、离职表这些都省略，直接作为 json 保存到 remarks</p>
<p>用 mybatis-plus，减少代码量。</p>
<p>比如有下面这个请假表字段：</p>
...
<p>其次，我们需要对多种审批流进行管理，还需要一个专门为审批流而设计的一个表：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> <span class="token identifier"><span class="token punctuation">`</span>act_process<span class="token punctuation">`</span></span> <span class="token punctuation">(</span>
...
<p>然后，activiti 自带了 mybatis，会和 mybatis-plus 冲突，需要排除：</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code>  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>org.activiti<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>activiti-spring-boot-starter<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>version</span><span class="token punctuation">></span></span>7.0.0.SR1<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>version</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改权限配置，对应角色，后续会用到这些角色：</p>
...
<h3 id="员工请假审批" tabindex="-1"><a class="header-anchor" href="#员工请假审批" aria-hidden="true">#</a> <span id="员工请假审批">员工请假审批</span></h3>
<h4 id="流程模型" tabindex="-1"><a class="header-anchor" href="#流程模型" aria-hidden="true">#</a> 流程模型</h4>
<p>这里已经算是开发内容了，实际系统的开发也差不多就这样。</p>
<p><strong>这里提到的都是关键步骤，不重要的自己看源码。</strong></p>
<p><strong>这里提到的都是关键步骤，不重要的自己看源码。</strong></p>
<p><strong>这里提到的都是关键步骤，不重要的自己看源码。</strong></p>
<p>说三遍了，下面全干货</p>
<p>先在上面提到的模块中画一个流程图</p>
<blockquote>
<p><strong>ID 为 AskLeaf</strong> ，<strong>整个ID作为后面开发中需要预设到系统里的</strong>。</p>
</blockquote>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220316232635323.png" alt=""></p>
<blockquote>
<p><strong>处理人使用通配符，这里写的 参数名 必须要在系统中 map 中传入值，不然报错</strong></p>
<p><strong>这里，我的开发习惯是，填写角色名称</strong></p>
</blockquote>
<ul>
<li>applyUser 表示流程发起人</li>
<li>groupManager 表示流程审批人</li>
</ul>
<p><code v-pre>其实这里也有过一个关于业务细节的思考，为什么创建流程的人，还需要占一个审批节点？</code></p>
<p><strong>把创建人作为一个审批节点，可以让创建人有一个撤回的机会。</strong></p>
<p>比如：张三创建了请假流程，然后日期填错了，但是他自己没有审批，相当于还没有发给领导。</p>
...
<p>审批人换了一个角色。</p>
<img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220316153657933 - 副本.png" alt="image-202203161536" style="zoom:80%;" />
<p>好了，部署流程上面已经提过了。</p>
<p>现在开始代码部分：</p>
...
<h4 id="代码实现流程创建" tabindex="-1"><a class="header-anchor" href="#代码实现流程创建" aria-hidden="true">#</a> 代码实现流程创建</h4>
<p>因为模拟 spring security 所以做了个登录步骤，请求类只包括：登录人、理由和时间：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Data</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接收数据第一步先登录，然后开始业务处理：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>核心的流程创建方法逻辑如下：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220317094707457.png" alt=""></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其他的跳过不说了，这里比较绕的，应该就是获取 <strong>流程参数</strong> 这个方法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
  * 启动一个流程时，有些参数需要动态返回
  */</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在绘制流程图时，我们用了通配符来定义审批角色：<code v-pre>applyUser 表示流程发起人</code>、<code v-pre>groupManager 表示流程审批人</code></p>
<p>这些都需要通过 <strong>variables</strong> 这个传入到 流程实例 中</p>
<p>这里的大致逻辑为：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220317100536964.png" alt=""></p>
<p>预设枚举类如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">enum</span> <span class="token class-name">WorkflowTypeEnum</span> <span class="token punctuation">{</span>
...
<p>**这里的每一个参数都很重要，根据 value 判断流程类别、根据 key 获得流程模型 **</p>
<p>**尤其要注意 roles，这是一个 <code v-pre>,</code> 拼接的字符串，也是对应审批流的通配符（不包括申请人） **</p>
</blockquote>
<p>最后完成执行，打印日志：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>2022-03-16 14:45:56.068  INFO 520 --- [p-nio-80-exec-2] c.s.a.service.EmployeeService            : 流程：请假，创建成功。业务编号：905a92518b5641f89a7f2327555adf37
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><hr>
<h4 id="流程任务查询" tabindex="-1"><a class="header-anchor" href="#流程任务查询" aria-hidden="true">#</a> 流程任务查询</h4>
<p>然后查看自己的流程就比较简单了，跳过；</p>
<p>这里预设了几种常用的任务情况：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">enum</span> <span class="token class-name">TaskTypeEnum</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220316164651287.png" alt=""></p>
<h4 id="确认提交请假申请" tabindex="-1"><a class="header-anchor" href="#确认提交请假申请" aria-hidden="true">#</a> 确认提交请假申请</h4>
<p>刚刚已经提过了，创建请假申请，已经完成了流程的创建。</p>
<ul>
<li>
<p><strong>第一个节点依然是申请人提交，表示：创建流程的员工，还需要点击确认</strong></p>
</li>
<li>
<p>那么对工作流来说，其实，<strong>申请提交这个动作，也是完成任务</strong></p>
</li>
</ul>
...
<p>审批入口，其实需要手动做的就是是否同意，然后填个意见。</p>
</blockquote>
<p>核心方法是完成审批 completeTask ，它的主要流程为：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220317115521200.png" alt=""></p>
<p>完成任务的递归方法代码：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其中：<code v-pre>updateProcess</code>、<code v-pre>completeTask</code> 这几个方法就省略了，全是 <code v-pre>get、set</code></p>
<blockquote>
<p>这里涉及到了完成流程、业务回调的功能。先不涉及，在后面介绍。</p>
</blockquote>
<br>
<h3 id="员工离职审批" tabindex="-1"><a class="header-anchor" href="#员工离职审批" aria-hidden="true">#</a> <span id="员工离职审批">员工离职审批</span></h3>
<p>这个案例中，实现两个功能：<strong>拒绝流程、完成回调。</strong></p>
<p>有没有发现，在上面的流程中，只是一条线，所以，无论你是同意还是拒绝，都会按顺序往下运行。</p>
<p>现在上新流程：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220317231423987.png" alt=""></p>
<p>与原流程相比，多了几条路线，并为路线设置了跳转条件。</p>
<p>这个也很明显，不过多解释。</p>
<blockquote>
<p><strong>如果任意一个审批步骤拒绝，就会结束流程</strong></p>
</blockquote>
<p>关键代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Transactional</span><span class="token punctuation">(</span>readOnly <span class="token operator">=</span> <span class="token boolean">false</span><span class="token punctuation">,</span> rollbackFor <span class="token operator">=</span> <span class="token class-name">Exception</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token class-name">List</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">Task</span><span class="token punctuation">></span></span> <span class="token function">competeTask</span><span class="token punctuation">(</span><span class="token class-name">CompleteTaskDTO</span> completeTaskDTO<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将是否同意审批的参数传入。</p>
<p><strong>如果本次的审批为拒绝，那么就直接结束流程，重置 业务process的参数</strong></p>
<p>在全部流程结束后，还可以触发回调：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//如果不存在下一个任务，那就可以调用结束回调方法</span>
<span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token class-name">CollectionUtils</span><span class="token punctuation">.</span><span class="token function">isEmpty</span><span class="token punctuation">(</span>nextTasks<span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// 调用业务回调</span>
    <span class="token class-name">String</span> callbackUrl <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">)</span> existVariables<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token class-name">WorkflowConstants</span><span class="token punctuation">.</span><span class="token constant">VARIABLE_CALLBACK_URL</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token class-name">String</span> businessKey <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">)</span> existVariables<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token class-name">WorkflowConstants</span><span class="token punctuation">.</span><span class="token constant">VARIABLE_BUSINESS_KEY</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code> [p-nio-80-exec-4] c.s.a.service.WorkflowCallBackService    : 工作流结束，回调触发：com.xxx.xx.x.ss()，回调参数：2df5731025d7410d810631e5b2173889
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><br>
<h3 id="费用报销多人会签" tabindex="-1"><a class="header-anchor" href="#费用报销多人会签" aria-hidden="true">#</a> <span id="费用报销多人会签">费用报销多人会签</span></h3>
<p>比如有这么一种情况，报销20块钱，需要 3个财务一起审批。</p>
<p>这种多人会签的情况，在实际业务中也很常见。。。</p>
<p>流程就不重新画了，就用那个离职审批，先加一个公司管理员的用户：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>那么现在就有两个公司管理员：<code v-pre>manager</code>、<code v-pre>system</code></p>
<p>修改流程如下：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220318115100069.png" alt=""></p>
<p>这里面的几个核心要点：</p>
<blockquote>
<ol>
<li><strong>多实例类型要选择：parallel 平行、 sequential 顺序</strong></li>
<li><strong>多实例集合要命名，这个一般在 Assignee 后加个 List</strong> ，例如 projectManager 对应 projectManagerList</li>
<li><strong>多实例变量要填上，和 Assignee 一样就行</strong></li>
<li><strong>完成添加需要补充，这里是只要有一个任务被拒绝，直接结束</strong></li>
</ol>
</blockquote>
<p>然后在根据角色编号获取 流程定义参数时，需要传入 多实例List 类型：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其他不变，看测试结果，可以看到已经有一个 manager 审批，但是流程并没有结束。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220318124625539.png" alt="image-20220318124625539"></p>
<br>
<h3 id="公司缺人离职不批" tabindex="-1"><a class="header-anchor" href="#公司缺人离职不批" aria-hidden="true">#</a> <span id="公司缺人离职不批">公司缺人离职不批</span></h3>
<p>比如现在，公司业务紧张，天天加班，你还想跑路？做梦都别想。</p>
<p><strong>所以这时候防止大家提交离职审批，可以把离职流程暂时挂起，不允许申请。</strong></p>
<p>这只是一个简单API，代码一放跳过：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
     * 挂起流程
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>测试下，把离职停了，最后请假正常创建，离职报错。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220318213042515.png" alt=""></p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220318213029686.png" alt="image-20220318213029686"></p>
<br>
<h3 id="流程签署自动提醒" tabindex="-1"><a class="header-anchor" href="#流程签署自动提醒" aria-hidden="true">#</a> <span id="流程签署自动提醒">流程签署自动提醒</span></h3>
<p>然后再看最后的事件监听，首先看上面会签中。</p>
<p>只能看到由哪几个角色进行了审批，但是 manager 和 system 是一个环节啊，能不能合在一起呢？</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220318194038333.png" alt=""></p>
<p>这里就可以加一个监听了。</p>
...
<p>直接加个监听器，继承 <code v-pre>ExecutionListener</code> ：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Component</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StartListener</span> <span class="token keyword">implements</span> <span class="token class-name">ExecutionListener</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220318223012166.png" alt=""></p>
<hr>
<p>会签监听：</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SignListener</span> <span class="token keyword">implements</span> <span class="token class-name">TaskListener</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220318220049988.png" alt="image-20220318220049988" style="zoom:80%;" />
...
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20220318223349082.png" alt=""></p>
<br>
<h2 id="其他功能" tabindex="-1"><a class="header-anchor" href="#其他功能" aria-hidden="true">#</a> <span id="其他功能">其他功能</span></h2>
<p>除了上面这些，Activiti 还有很多其他更加复杂的操作功能：</p>
<ul>
<li><strong>网关：排他、并行、包含、事件</strong></li>
<li><strong>触发：短信、邮件等</strong></li>
</ul>
<p>因为还没有用到，估计也用不太到，所以就不涉及了。</p>
...
<ol>
<li><a href="https://blog.csdn.net/weixin_46990523/article/details/109473507" target="_blank" rel="noopener noreferrer">Activiti7工作流引擎_Roc的博客-CSDN博客_activiti工作流引擎<ExternalLinkIcon/></a></li>
<li><a href="https://www.bilibili.com/video/BV1H54y167gf?p=3" target="_blank" rel="noopener noreferrer">黑马程序员java教程最新工作流引擎Activiti7基础到进阶，Activiti和Spring框架、SpringBoot整合_哔哩哔哩_bilibili<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/feiniao168/article/details/83889966" target="_blank" rel="noopener noreferrer">BPMN详细介绍_feiniao168的专栏-CSDN博客<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/qq_34839150/article/details/109903454" target="_blank" rel="noopener noreferrer">SpringBoot整合Activiti7使用_菜菜的博客-CSDN博客_springboot整合activiti7<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/qq_38423256/article/details/116332791" target="_blank" rel="noopener noreferrer">Activiti7工作流引擎之常用API操作_喜羊羊love红太狼-CSDN博客_activiti7的api<ExternalLinkIcon/></a></li>
</ol>
</div></template>
