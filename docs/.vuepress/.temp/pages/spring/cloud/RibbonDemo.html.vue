...
<p><em>2021.10.23，spring cloud 以前只零碎用过几个组件，这次系统学一遍</em></p>
...
<hr>
<p><strong>代码仓库 ribbon-demo 分支</strong> ：<a href="https://gitee.com/learning-use-cases/spring-cloud-demo/tree/ribbon-demo/" target="_blank" rel="noopener noreferrer">Learning Use Cases/Spring Cloud Demo - Gitee.com<ExternalLinkIcon/></a></p>
<p>本文介绍 spring cloud 负载均衡工具 Ribbon ，提供客户端负载均衡算法和服务调用。Ribbon 提供了：连接超时、重试、负载均衡规则配置等一系列完善配置。</p>
<p>Ribbon 也半死不活，不更新了只维护，但还是要了解下。</p>
<br/>
<h2 id="负载均衡差异" tabindex="-1"><a class="header-anchor" href="#负载均衡差异" aria-hidden="true">#</a> 负载均衡差异</h2>
<p>公司目前项目负载均衡仍然使用的是 nginx。两者的差别是：</p>
<ul>
<li>Nginx 是服务器负载均衡，所有请求都由 Nginx 转发实现。</li>
</ul>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20211023010004866.png" alt="image-20211023010004866"></p>
<ul>
<li>Ribbon 是本地负载均衡，在调用服务的时候会从注册中心下载注册服务列表到JVM（消费者方的），从本地调用 RPC 实现。</li>
</ul>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20211023005809138.png" alt="image-20211023005809138"></p>
<br/>
<h2 id="ribbon-使用" tabindex="-1"><a class="header-anchor" href="#ribbon-使用" aria-hidden="true">#</a> Ribbon 使用</h2>
<p>一句话概括 Ribbon 其实就是： <strong>负载均衡 + RestTemplate</strong> ，它同时实现了负载均衡算法实现 和 服务调用。</p>
<p>客户端 POM 引入依赖：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Application 加上服务发现的注解：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>加入 restTemplate 配置：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>调用方式：</p>
...
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20211023100543467.png" alt="image-20211023100543467"></p>
<p>调用结果，轮询调用两个服务：</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20211023100713551.png" alt="image-20211023100713551"></p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20211023100732140.png" alt="image-20211023100732140"></p>
<br/>
<h2 id="负载均衡算法" tabindex="-1"><a class="header-anchor" href="#负载均衡算法" aria-hidden="true">#</a> 负载均衡算法</h2>
<p>需要自定义负载均衡算法、或者 Ribbon 其他配置，可以通过外部的属性<code v-pre>.ribbon.*</code>来配置一些Ribbon Client。</p>
<p>Spring Cloud Netflix为ribbon提供了如下的Beans(BeanType beanName: ClassName):</p>
<ul>
...
<blockquote>
<p>警告：配置 不能被 @ComponentScan 在 main application context。</p>
<p>这样的话，它将被所有 @RibbonClients 共享。如果你使用 @ComponentScan (or @SpringBootApplication) ，你需要避免它被包括其中。(例如：放它到一个独立的，无重叠的包里，或者指明不被@ComponentScan扫描)。</p>
</blockquote>
<p><strong>简单来说，就是别放在 Application 所在的包下面。</strong></p>
<hr>
<p>Ribbon 的算法策略有以下几种，不过 Ribbon已经不更新了，而且 OpenFegin 也默认实现了，到时候再说。这里就不测试了。</p>
<p><img src="https://shiva.oss-cn-hangzhou.aliyuncs.com/picture-master/images/image-20211023120833720.png" alt="image-20211023120833720"></p>
<br/>
...
<p><a href="http://docs.springcloud.cn/user-guide/ribbon/" target="_blank" rel="noopener noreferrer">Spring Cloud ribbon - Spring Cloud中国社区<ExternalLinkIcon/></a></p>
<p><a href="https://www.jianshu.com/p/1bd66db5dc46" target="_blank" rel="noopener noreferrer">Ribbon详解 - 简书 (jianshu.com)<ExternalLinkIcon/></a></p>
</div></template>
