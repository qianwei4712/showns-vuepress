...
<blockquote>
<p>环境： <code v-pre>jdk 8</code>、<code v-pre>springboot 2.4.9</code>、<code v-pre>activemq 5.15.15</code></p>
</blockquote>
<p><strong>JMS术语：</strong></p>
<ul>
...
<li>Connnection：JMS Client 到 JMS Provider的连接</li>
<li>Destination：消息目的地，由 Session 创建</li>
<li>Session：会话，由 Connection 创建，实质上就是发送、接受消息的一个线程，因此生产者、消费者都是Session创建的</li>
</ul>
...
<tr>
<td>queue 点对点传输</td>
<td>一个生产者对应一个消费者，生产者向broke推送数据，数据存储在broke的一个队列中，当消费者接受该条队列里的数据</td>
<td>可以接收到在连接之前生产者所推送的数据</td>
</tr>
<tr>
<td>topic 基于发布/订阅模式的传输</td>
<td>根据订阅话题来接收相应数据，一个生产者可向多个消费者推送数据</td>
<td>只能接收到连接之后生产者推送的数据</td>
</tr>
</tbody>
</table>
<br>
<h2 id="依赖配置" tabindex="-1"><a class="header-anchor" href="#依赖配置" aria-hidden="true">#</a> 依赖配置</h2>
<p>添加依赖：</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>application.yml 配置：</p>
...
<h2 id="队列模式" tabindex="-1"><a class="header-anchor" href="#队列模式" aria-hidden="true">#</a> 队列模式</h2>
<p>生产者：</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ProducerController</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>消费者：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Component</span>
...
<h2 id="订阅模式" tabindex="-1"><a class="header-anchor" href="#订阅模式" aria-hidden="true">#</a> 订阅模式</h2>
<p>配置文件：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">pub-sub-domain</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>生产者：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Component</span>
...
<h2 id="通配符订阅" tabindex="-1"><a class="header-anchor" href="#通配符订阅" aria-hidden="true">#</a> 通配符订阅</h2>
<p>ActiveMQ 支持三种 <code v-pre>.</code> 、<code v-pre>*</code>、<code v-pre>&gt;</code> ：</p>
<ul>
<li><strong>.</strong> 用于作为路径上名字间的分隔符</li>
<li>***** 用于匹配路径上的任何名字</li>
<li><strong>&gt;</strong> 用于递归地匹配任何以这个名字开始的destination</li>
</ul>
<br>
<h2 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> 参考文章</h2>
<p><a href="https://www.cnblogs.com/yufeng218/p/11509486.html" target="_blank" rel="noopener noreferrer">SpringBoot 整合 ActiveMq - 风止雨歇 - 博客园 (cnblogs.com)<ExternalLinkIcon/></a></p>
<p><a href="https://blog.csdn.net/spd96363/article/details/108645809" target="_blank" rel="noopener noreferrer">SpringBoot集成ActiveMQ实例详解_罗马没假日-CSDN博客<ExternalLinkIcon/></a></p>
<p><a href="https://blog.csdn.net/newbie0107/article/details/106592008" target="_blank" rel="noopener noreferrer">ActiveMQ通配符式订阅_BXS-CSDN博客_activemq 通配符<ExternalLinkIcon/></a></p>
</div></template>
